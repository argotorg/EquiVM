...
- `truthCorrect` now splits the non-OOG selector-match `JUMPI` by selector equality. The selector-mismatch fallback side is wired through `JUMPDEST; PUSH0; PUSH0; REVERT` and its fuel bounds are discharged; the selector-match equality side now builds the taken selector branch, closes OOG throughout `JUMPDEST; PUSH1 0x30; PUSH1 0x44; JUMP`, closes OOG across the whole pure body `JUMPDEST; PUSH0; PUSH1 0x01; SWAP1; POP; SWAP1; JUMP`, continues through the return-continuation `JUMPDEST; PUSH1 0x40; MLOAD; PUSH1 0x3b; SWAP2; SWAP1; PUSH1 0x64; JUMP`, closes OOG across the first ABI encoder entry chunk `JUMPDEST; PUSH0; PUSH1 0x20; DUP3; ADD; SWAP1; POP`, closes OOG/continue through `PUSH1 0x75; PUSH0; DUP4; ADD; DUP5; PUSH1 0x57; JUMP`, closes OOG/continue through the boolean-writer entry `JUMPDEST; PUSH1 0x5e; DUP2; PUSH1 0x4c; JUMP`, closes OOG/continue through the full boolean normalizer `JUMPDEST; PUSH0; DUP2; ISZERO; ISZERO; SWAP1; POP; SWAP2; SWAP1; POP; JUMP`, closes OOG/continue through the boolean store block `JUMPDEST; DUP3; MSTORE; POP; POP; JUMP`, and now closes OOG/continue through ABI encoder cleanup `JUMPDEST; SWAP3; SWAP2; POP; POP; JUMP` to reach the final return continuation at pc `0x3b` when gas allows.
- The reusable selector bridge now connects `calldata.extract 0 4` with `UInt256.shiftRight (uInt256OfByteArray (calldata.readBytes 0 32)) 0xe0`; the remaining main-proof work is to split and assemble the final return continuation from pc `0x3b` onward through the packaged final-return segment.
