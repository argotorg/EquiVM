import Solm.Examples.UniswapV2Pair.MintRuntimeFinalize
import Solm.Examples.UniswapV2Pair.MintInternalMintRuntime
import Solm.Examples.UniswapV2Pair.MintFeeSqrtSmall
import Solm.Examples.UniswapV2Pair.SyncCumulative
...
theorem uniswapMintFeeOnKLastNonzeroNoMintCase
      ...
      typedCallViaEVM config
        ...
        [.address
          (uniswapLockEnteredState
            (initState cA gh bl σ_solm σ₀ (Sat256.ofUInt256 g) A I)).executionEnv.codeOwner]
        (true, evm0S, o) false)
    (hdec0 : config.externalABI.decode? "balanceOf" o = some [uniswapUint256Abi balance0])
    (hcall1 :
    ...
    (hdec1 : config.externalABI.decode? "balanceOf" o1 = some [uniswapUint256Abi balance1])
    (hle0Source :
      (uniswapReserve0Word
          (uniswapLockEnteredState
