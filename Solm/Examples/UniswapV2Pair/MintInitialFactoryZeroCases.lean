import Solm.Examples.UniswapV2Pair.MintInitialZeroCases
...
theorem uniswapMintInitialFeeOffKLastZeroLiquidityZeroFromFactoryWitnessCase
  ...
  exact uniswapMintInitialAfterMintFeeLiquidityZeroRevertCase nextFrame.locals
    rootLiquidity hcode hdispatch hsz36 hwv hunlockedSolm hguard0 hguard1 hcall0
    hdec0 hcall1 hdec1 hle0Source hle1Source hfee
    ...
    hrootGeMin hliquidity hliquidityZero hfitSupplyMinSource hfitBalanceMinSource
    htotalFitMin hbalanceFitMin hperm hmem hmem64
...
theorem uniswapMintInitialFeeOffKLastNonzeroLiquidityZeroFromFactoryWitnessCase
  ...
  exact uniswapMintInitialAfterMintFeeLiquidityZeroRevertCase nextFrame.locals
    ...
    hrootSize hrootGeMin hliquidity hliquidityZero hfitSupplyMinSource
