import Solm.Examples.UniswapV2Pair.MintFeeOnKLastNonzeroInitialFactoryCases
import Solm.Examples.UniswapV2Pair.MintInitialFactoryOverflowCases
import Solm.Examples.UniswapV2Pair.MintInitialFactorySecondMintReverts
import Solm.Examples.UniswapV2Pair.MintInitialFactorySecondMintBalanceReverts
...
theorem uniswapMintFeeOnKLastNonzeroInitialMinimumBalanceOverflowFromFactoryCase
    ...
    (hdec0 : config.externalABI.decode? "balanceOf" out0 = some [uniswapUint256Abi balance0])
    (hcall1 :
    ...
    (hdec1 : config.externalABI.decode? "balanceOf" out1 = some [uniswapUint256Abi balance1])
    (hle0Source :
      (uniswapReserve0Word
          (uniswapLockEnteredState
