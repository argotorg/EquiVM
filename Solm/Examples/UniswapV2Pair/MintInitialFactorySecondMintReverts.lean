import Solm.Examples.UniswapV2Pair.MintInitialSecondMintReverts
...
theorem uniswapMintInitialFeeOffKLastZeroSecondMintTotalSupplyOverflowFromFactoryWitnessCase
  ...
  exact uniswapMintInitialAfterMintFeeSecondMintTotalSupplyOverflowRevertCase
    ...
    htotalFitMin hbalanceFitMin hsourceOverflow hruntimeOverflow hperm hmem hmem64

set_option maxHeartbeats 1000000 in
theorem uniswapMintInitialFeeOnKLastZeroSecondMintTotalSupplyOverflowFromFactoryWitnessCase
    {cA gh bl σ_evm σ_solm σ₀ A I} {g : UInt256}
    {cAFee : Batteries.RBSet AccountAddress compare} {σFee : AccountMap}
    {evm0S evm1S evmFeeS : EVM.State}
    {out0 out1 outFee mem rdata : ByteArray} {k C : ℕ}
...
set_option maxHeartbeats 1000000 in
theorem uniswapMintInitialFeeOffKLastNonzeroSecondMintTotalSupplyOverflowFromFactoryWitnessCase
    {cA gh bl σ_evm σ_solm σ₀ A I} {g : UInt256}
    {cAFee : Batteries.RBSet AccountAddress compare} {σFee : AccountMap}
    {evm0S evm1S evmFeeS : EVM.State}
    {out0 out1 outFee mem rdata : ByteArray} {k C : ℕ}
