import Solm.Benchmarks.Dss.Cat.Storage
import Solm.Reasoning.ExternalCall
...
theorem RD.catFileIlkFlipDecodeToRoutine {g : Sat256} {s0 : State}
  ...
  have rd756 := h.jumpdest (by native_decide) (by evm_ov)
  have rd757 := rd756.pop (by native_decide) (by evm_ov)
  have rd758 := rd757.dup1 (by native_decide) (by evm_ov)
  have rd759 := rd758.calldataload (by native_decide) (by evm_ov)
  have rd760 := rd759.swap1 (by native_decide) (by evm_ov)
  have rd762 := rd760.push1 ⟨32⟩ (by native_decide) (by evm_ov)
  have rd763 := rd762.dup2 (by native_decide) (by evm_ov)
  have rd764 := rd763.add (by native_decide) (by evm_ov)
  have rd765 := rd764.calldataload (by native_decide) (by evm_ov)
  have rd766 := rd765.swap1 (by native_decide) (by evm_ov)
  have rd768 := rd766.push1 ⟨64⟩ (by native_decide) (by evm_ov)
  have rd769 := rd768.add (by native_decide) (by evm_ov)
  have rd770 := rd769.calldataload (by native_decide) (by evm_ov)
  have rd772 := rd770.push1 ⟨1⟩ (by native_decide) (by evm_ov)
  have rd774 := rd772.push1 ⟨1⟩ (by native_decide) (by evm_ov)
  have rd776 := rd774.push1 ⟨160⟩ (by native_decide) (by evm_ov)
  have rd777 := rd776.shl (by native_decide) (by evm_ov)
  have rd778 := rd777.sub (by native_decide) (by evm_ov)
  have rd779 := rd778.and (by native_decide) (by evm_ov)
  have rd782 := rd779.push2 ⟨3366⟩ (by native_decide) (by evm_ov)
  exact ⟨_, _, by
    simpa [calldataWord, show (⟨4⟩ : UInt256).toNat = 4 from by decide,
      show (⟨32⟩ : UInt256).toNat = 32 from by decide,
      show (⟨64⟩ : UInt256).toNat = 64 from by decide, solcAddrMask]
      using rd782.jump (by native_decide) hroutine (by evm_ov)⟩
...
theorem RD.catFileIlkFlipWhatFlip {g : Sat256} {s0 : State} {ee : ExecutionEnv}
  ...
  have rd3456 := h.jumpdest (by native_decide) (by evm_ov)
  have rd3457 := rd3456.dup2 (by native_decide) (by evm_ov)
  have rd3462 := rd3457.push4 ⟨107398807⟩ (by native_decide) (by evm_ov)
  have rd3464 := rd3462.push1 ⟨228⟩ (by native_decide) (by evm_ov)
  have rd3465 := rd3464.shl (by native_decide) (by evm_ov)
  rw [fileIlkFlipConst_eq, ← hmatch] at rd3465
  have rd3466 := rd3465.eq (by native_decide) (by evm_ov)
  rw [uInt256_eq_self] at rd3466
  have rd3467 := rd3466.iszero (by native_decide) (by evm_ov)
  rw [show UInt256.isZero (⟨1⟩ : UInt256) = ⟨0⟩ from by decide] at rd3467
  have rd3470 := rd3467.push2 ⟨953⟩ (by native_decide) (by evm_ov)
  exact ⟨_, _, rd3470.jumpiNT (by native_decide) (by decide : (⟨0⟩ : UInt256) = ⟨0⟩)
    (by evm_ov)⟩
...
theorem RD.catFileIlkFlipWhatSkip {g : Sat256} {s0 : State} {ee : ExecutionEnv}
  ...
  have rd3470 := rd3467.push2 ⟨953⟩ (by native_decide) (by evm_ov)
  exact ⟨_, _, rd3470.jumpiT (by native_decide) one_ne_zero_uint (by jump_dest) (by evm_ov)⟩
...
theorem RD.catFileIlkFlipNopeEncode {cA gh bl σ σ₀ A I} {g : Sat256} {flip ret sel : UInt256}
  ...
  have rd3476 := rd3474.push1 ⟨0⟩ (by native_decide) (by evm_ov)
  have rd3477 := rd3476.dup5 (by native_decide) (by evm_ov)
  have rd3478 := rd3477.dup2 (by native_decide) (by evm_ov)
  ...
  have rd3481 := rd3479.push1 ⟨1⟩ (by native_decide) (by evm_ov)
  have rd3483 := rd3481.push1 ⟨32⟩ (by native_decide) (by evm_ov)
  have rd3484 := rd3483.mstore 0 (fifKeccakMem I) (UInt256.ofNat 3)
    (by native_decide) mem_cost (by rfl) (by native_decide) (by evm_ov)
  have rd3486 := rd3484.push1 ⟨64⟩ (by native_decide) (by evm_ov)
  have rd3487 := rd3486.dup1 (by native_decide) (by evm_ov)
  have rd3488 := rd3487.dup3 (by native_decide) (by evm_ov)
  have rd3489 := rd3488.keccak256 0 (solcMappingSlot ⟨1⟩ (fileIlkFlipIlkWord I))
    (UInt256.ofNat 3) (by native_decide) mem_cost hkeccak (by native_decide) (by evm_ov)
  obtain ⟨_, _, rd3490⟩ := rd3489.sload (by native_decide) (by evm_ov)
  have rd3491 := rd3490.dup2 (by native_decide) (by evm_ov)
  have rd3492 := rd3491.mload 0 ⟨128⟩ (UInt256.ofNat 3) (by native_decide) mem_cost hmload
    (by native_decide) (by evm_ov)
  -- 3492..3517: build the nope calldata (selector + masked old flip) at 128
  have rd3497 := rd3492.push4 ⟨1848021117⟩ (by native_decide) (by evm_ov)
  have rd3499 := rd3497.push1 ⟨225⟩ (by native_decide) (by evm_ov)
  have rd3500 := rd3499.shl (by native_decide) (by evm_ov)
  have rd3501 := rd3500.dup2 (by native_decide) (by evm_ov)
  have rd3502 := rd3501.mstore 6 (fifNopeSelMem I) (UInt256.ofNat 5)
    ...
    (by native_decide) (by evm_ov)
  have rd3504 := rd3502.push1 ⟨1⟩ (by native_decide) (by evm_ov)
  have rd3506 := rd3504.push1 ⟨1⟩ (by native_decide) (by evm_ov)
  have rd3508 := rd3506.push1 ⟨160⟩ (by native_decide) (by evm_ov)
  have rd3509 := rd3508.shl (by native_decide) (by evm_ov)
  have rd3510 := rd3509.sub (by native_decide) (by evm_ov)
  rw [show UInt256.sub (UInt256.shiftLeft (⟨1⟩ : UInt256) ⟨160⟩) ⟨1⟩ = solcAddrMask from by decide]
    at rd3510
  have rd3511 := rd3510.swap2 (by native_decide) (by evm_ov)
  have rd3512 := rd3511.dup3 (by native_decide) (by evm_ov)
  have rd3513 := rd3512.and (by native_decide) (by evm_ov)
  have rd3515 := rd3513.push1 ⟨4⟩ (by native_decide) (by evm_ov)
  have rd3516 := rd3515.dup3 (by native_decide) (by evm_ov)
  have rd3517 := rd3516.add (by native_decide) (by evm_ov)
  ...
  have rd3523 := rd3522.swap3 (by native_decide) (by evm_ov)
  have rd3528 := rd3523.push4 ⟨3696042234⟩ (by native_decide) (by evm_ov)
  have rd3529 := rd3528.swap3 (by native_decide) (by evm_ov)
  have rd3531 := rd3529.push1 ⟨36⟩ (by native_decide) (by evm_ov)
  have rd3532 := rd3531.dup1 (by native_decide) (by evm_ov)
  have rd3533 := rd3532.dup5 (by native_decide) (by evm_ov)
  have rd3534 := rd3533.add (by native_decide) (by evm_ov)
  rw [show (⟨128⟩ : UInt256) + ⟨36⟩ = ⟨164⟩ from by decide] at rd3534
  have rd3535 := rd3534.swap4 (by native_decide) (by evm_ov)
  have rd3536 := rd3535.swap2 (by native_decide) (by evm_ov)
  have rd3537 := rd3536.swap3 (by native_decide) (by evm_ov)
  have rd3539 := rd3537.swap2 (by native_decide) (by evm_ov)
  have rd3540 := rd3539.dup3 (by native_decide) (by evm_ov)
  have rd3541 := rd3540.swap1 (by native_decide) (by evm_ov)
  have rd3542 := rd3541.sub (by native_decide) (by evm_ov)
  rw [show UInt256.sub ⟨128⟩ ⟨128⟩ = ⟨0⟩ from by decide] at rd3542
  have rd3543 := rd3542.add (by native_decide) (by evm_ov)
  rw [show (⟨0⟩ : UInt256) + ⟨36⟩ = ⟨36⟩ from by decide] at rd3543
  have rd3544 := rd3543.dup2 (by native_decide) (by evm_ov)
  have rd3545 := rd3544.dup4 (by native_decide) (by evm_ov)
  have rd3546 := rd3545.dup8 (by native_decide) (by evm_ov)
  exact ⟨_, _, rd3546.dup1 (by native_decide) (by evm_ov)⟩
