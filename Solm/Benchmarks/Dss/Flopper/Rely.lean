import Solm.Benchmarks.Dss.Flopper.Dispatch
...
theorem flopperDecode_rely_ok {I : ExecutionEnv} (hsz36 : 36 ≤ I.calldata.size) :
...
theorem flopperDecode_rely_none_short {I : ExecutionEnv}
...
theorem flopperReachRelyBody {cA gh bl σ σ₀ A I} {g : Sat256}
  ...
  have htake :
      UInt256.eq (armSelNat flopperBytecode (nthArmPc flopperBytecode flopperLowHighFirstArmPc 2))
        (flopperSelWord I) ≠ ⟨0⟩ := by
    rw [hword]
    native_decide
  exact RD.dispatchTo ⟨582⟩ 2 hfirst
...
theorem flopperRelyX_decoded {cA gh bl σ σ₀ A I} {g : Sat256} {sel : UInt256}
  ...
  obtain ⟨_, _, hroutine⟩ := RD.solcOneAddressExternalMaskAndJumpMasked
    (code := flopperBytecode) (decoded := ⟨604⟩) (ret := ⟨334⟩) (routine := ⟨3009⟩)
    (R := [sel]) hdecoded
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
...
theorem flopperRelyX_authorized {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
  ...
  have rd1743 := rd1740pre.pushConst (⟨3102⟩ : UInt256)
  ...
  have hbody :
    ...
    simpa [evmSolm, relyAuthWord, flopperSlotWord, initState, Solm.EVM.storageLoad,
      ...
      flopperRelyBodyReverts evmSolm I
        ...
        (by simp [evmSolm, initState])
        hauthWord
  exact (flopperX_rely_unauthorized (g := Sat256.ofUInt256 g) hsz36 hsize hauth hreach)
