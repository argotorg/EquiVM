import Solm.Benchmarks.Dss.LinearDecrease.Common
import Solm.Reasoning.Constructor
import EVMReasoning.Initcode
import Solm.Equiv

/-!
# MakerDAO/Sky DSS LinearDecrease constructor correctness
-/
...
theorem stairstepCreationBytecode_size :
    linearDecreaseCreationBytecode.size = 1217 := by
  native_decide

theorem stairstepBytecode_size :
    linearDecreaseBytecode.size = 1128 := by
  native_decide

theorem stairstepCreationBytecode_runtime_window :
    linearDecreaseCreationBytecode.extract 89 (89 + 1128) =
...
noncomputable def stairstepCtorReturnMem (I : ExecutionEnv) : ByteArray :=
  linearDecreaseCreationBytecode.write 89 (stairstepCtorWardsHashMem I) 0 1128
...
theorem stairstepCtorReturnMem_read (I : ExecutionEnv) :
    (stairstepCtorReturnMem I).readWithPadding 0 1128 =
      linearDecreaseBytecode := by
  unfold stairstepCtorReturnMem
  rw [write0_read_back_from_gen linearDecreaseCreationBytecode
    (stairstepCtorWardsHashMem I) 89 1128
...
theorem stairstepCtorInitcodeSuccess {cA gh bl σ σ₀ A I} {g : Sat256}
  ...
  have hcopy :
      linearDecreaseCreationBytecode.write 89
          (stairstepCtorWardsHashMem I) 0 1128 =
        stairstepCtorReturnMem I := by
    rfl
  have rd85pre := evm_run rd75 with [
    raw push2 ⟨1128⟩ (by native_decide) (by evm_ov),
    raw dup1 (by native_decide) (by evm_ov),
    raw push2 ⟨89⟩ (by native_decide) (by evm_ov),
    raw push1 ⟨0⟩ (by native_decide) (by evm_ov),
    raw codecopy
      (Cₘ (UInt256.ofNat (MachineState.M (UInt256.ofNat 3).toNat 0 1128)) -
        Cₘ (UInt256.ofNat 3))
      (stairstepCtorReturnMem I) (UInt256.ofNat 36)
      (by native_decide) mem_cost hcopy (by native_decide) (by evm_ov),
    raw push1 ⟨0⟩ (by native_decide) (by evm_ov)]
  exact rd85pre.ret 0 linearDecreaseBytecode
