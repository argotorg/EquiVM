import Solm.Benchmarks.Dss.ExponentialDecrease.Common
...
theorem stairstepCtorReturnMem_read (I : ExecutionEnv) :
    (stairstepCtorReturnMem I).readWithPadding 0 1321 =
      exponentialDecreaseBytecode := by
  unfold stairstepCtorReturnMem
  rw [write0_read_back_from_gen exponentialDecreaseCreationBytecode
    (stairstepCtorWardsHashMem I) 89 1321
...
theorem stairstepCtorInitcodeRevert {cA gh bl σ σ₀ A I} {g : Sat256}
    (hcode : I.code = exponentialDecreaseCreationBytecode)
    (hwv : I.weiValue ≠ ⟨0⟩) :
    RDrev exponentialDecreaseCreationBytecode g
      (initState cA gh bl σ σ₀ g A I) := by
  have rd0 :
      RD exponentialDecreaseCreationBytecode I g
...
theorem stairstepCtorInitcodeSuccess {cA gh bl σ σ₀ A I} {g : Sat256}
    ...
    (hperm : I.perm = true)
    (hwv : I.weiValue = ⟨0⟩) :
    RDret exponentialDecreaseCreationBytecode g
  ...
  have hcopy :
      exponentialDecreaseCreationBytecode.write 89
          (stairstepCtorWardsHashMem I) 0 1321 =
