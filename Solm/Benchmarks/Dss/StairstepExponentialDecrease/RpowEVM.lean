import Solm.Benchmarks.Dss.StairstepExponentialDecrease.RpowSource
...
theorem RD.stairstepRpowXZeroNNonzeroReturns
    ...
    (hRlen : R.length ≤ 1000)
    (hnz : n ≠ ⟨0⟩)
    (rd1042 : RD stairstepExponentialDecreaseBytecode I g s0 ⟨1042⟩
      (b :: n :: ⟨0⟩ :: ⟨707⟩ :: R) mem aw out acc k C) :
...
theorem RD.stairstepRpowToLoop
    ...
    (hx : x ≠ ⟨0⟩)
    (rd1042 : RD stairstepExponentialDecreaseBytecode I g s0 ⟨1042⟩
      (b :: n :: x :: ⟨707⟩ :: R) mem aw out acc k C) :
    let half := UInt256.div b ⟨2⟩
    let z := if n.toNat % 2 = 0 then b else x
    let n' := UInt256.div n ⟨2⟩
    ∃ scratch₁ scratch₂ k' C',
      RD stairstepExponentialDecreaseBytecode I g s0 ⟨1092⟩
...
theorem RD.stairstepRpowLoopExit
    ...
    (rd1092 : RD stairstepExponentialDecreaseBytecode I g s0 ⟨1092⟩
      (half :: scratch₁ :: scratch₂ :: z :: b :: ⟨0⟩ :: x :: ⟨707⟩ :: R)
      mem aw out acc k C) :
...
theorem RD.stairstepRpowLoopBodyEntry
    ...
    (rd1092 : RD stairstepExponentialDecreaseBytecode I g s0 ⟨1092⟩
      (half :: scratch₁ :: scratch₂ :: z :: b :: n :: x :: ⟨707⟩ :: R)
      mem aw out acc k C) :
    ∃ k' C', RD stairstepExponentialDecreaseBytecode I g s0 ⟨1099⟩
      (half :: scratch₁ :: scratch₂ :: z :: b :: n :: x :: ⟨707⟩ :: R)
      mem aw out acc k' C' := by
  have rd1098pre := evm_run rd1092 with [
    raw jumpdest (by native_decide) (by evm_ov),
...
theorem RD.stairstepRpowLoopRevertXX
    ...
    (hRlen : R.length ≤ 1000)
    (hover : UInt256.size ≤ x.toNat * x.toNat)
    (rd1099 : RD stairstepExponentialDecreaseBytecode I g s0 ⟨1099⟩
      (half :: scratch₁ :: scratch₂ :: z :: b :: n :: x :: ⟨707⟩ :: R)
      mem aw out acc k C) :
...
theorem RD.stairstepRpowLoopOddTailEntry
    ...
    ∃ k' C', RD stairstepExponentialDecreaseBytecode I g s0 ⟨1147⟩
      (half :: scratch₁ :: scratch₂ :: z :: b :: n :: x' :: ⟨707⟩ :: R)
      mem aw out acc k' C' := by
  intro xx xxRound x'
  have hshiftZero : UInt256.isZero (UInt256.shiftRight x (⟨128⟩ : UInt256)) ≠ ⟨0⟩ := by
...
theorem RD.stairstepRpowLoopStepEven
    ...
    let x' := UInt256.div xxRound b
    let n' := UInt256.div n ⟨2⟩
    ∃ k' C', RD stairstepExponentialDecreaseBytecode I g s0 ⟨1092⟩
      (half :: scratch₁ :: scratch₂ :: z :: b :: n' :: x' :: ⟨707⟩ :: R)
      mem aw out acc k' C' := by
...
theorem rpowLoopCoupled
    ...
    (∃ xFinal zFinal localsFinal k' C',
      ...
      RD stairstepExponentialDecreaseBytecode I g s0 ⟨707⟩
