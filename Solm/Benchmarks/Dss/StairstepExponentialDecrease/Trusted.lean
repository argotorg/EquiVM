import Solm.Benchmarks.Dss.StairstepExponentialDecrease.Common

/-!
# MakerDAO/Sky DSS StairstepExponentialDecrease trusted selector facts
...
axiom stepSelectorBytes :
    (ffi.KEC (String.toByteArray (transitionSigStr stepTransition))).extract 0 4 =
      stairstepSelBytes 5
