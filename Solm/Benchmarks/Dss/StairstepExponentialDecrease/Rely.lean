import Solm.Benchmarks.Dss.StairstepExponentialDecrease.Dispatch
...
theorem stairstepReachRelyBody {cA gh bl σ σ₀ A I} {g : Sat256}
  ...
  have htake :
      UInt256.eq
        (armSelNat stairstepExponentialDecreaseBytecode
          (nthArmPc stairstepExponentialDecreaseBytecode stairstepLowFirstArmPc 2))
        (stairstepSelWord I) ≠ ⟨0⟩ := by
    rw [hword]
    native_decide
  exact stairstepReachLowBody 2 (by omega) stairstepRelyEntryPc hcode hwv hsz hsize
...
theorem stairstepRelyX_decoded {cA gh bl σ σ₀ A I} {g : Sat256} {sel : UInt256}
    ...
    (hreach : ∃ k C, RD stairstepExponentialDecreaseBytecode I g
      (initState cA gh bl σ σ₀ g A I) stairstepRelyEntryPc [sel]
      solcFreePtrMem (UInt256.ofNat 3) ByteArray.empty (cA, σ) k C) :
    ∃ k C, RD stairstepExponentialDecreaseBytecode I g
        (initState cA gh bl σ σ₀ g A I) ⟨719⟩
        [relyUsrMaskedWord I, ⟨165⟩, sel]
        solcFreePtrMem (UInt256.ofNat 3) ByteArray.empty (cA, σ) k C := by
  obtain ⟨_, _, hdecoded⟩ := RD.solcOneAddressExternalLenOk
    (code := stairstepExponentialDecreaseBytecode) (sel := sel)
    (entry := stairstepRelyEntryPc) (ret := ⟨165⟩) (decoded := ⟨242⟩) hreach
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by jump_dest) hsz36 hsize
  obtain ⟨_, _, hroutine⟩ := RD.solcOneAddressExternalMaskAndJumpMasked
    (code := stairstepExponentialDecreaseBytecode) (decoded := ⟨242⟩) (ret := ⟨165⟩)
    (routine := ⟨719⟩) (R := [sel]) hdecoded
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
...
theorem stairstepRelyX_shortarg {cA gh bl σ σ₀ A I} {g : Sat256} {sel : UInt256}
  ...
  exact RD.solcExternalStaticArgsShortReverts
    (code := stairstepExponentialDecreaseBytecode) (sel := sel)
    (entry := stairstepRelyEntryPc) (ret := ⟨165⟩) (decoded := ⟨242⟩)
    (need := ⟨32⟩) hreach
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
    (by native_decide) (by native_decide) (by native_decide) (by native_decide)
...
theorem stairstepRelyX_authorized {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
    ...
    (h : RD stairstepExponentialDecreaseBytecode I g s0 ⟨719⟩
      [relyUsrMaskedWord I, ⟨165⟩, sel]
      solcFreePtrMem (UInt256.ofNat 3) ByteArray.empty (cA, σ) k C) :
    ∃ k' C', RD stairstepExponentialDecreaseBytecode I g s0 ⟨797⟩
      [relyUsrMaskedWord I, ⟨165⟩, sel]
  ...
  have rd736 : RD stairstepExponentialDecreaseBytecode I g s0 ⟨736⟩
  ...
  have rd742 := rd739pre.pushConst (⟨797⟩ : UInt256)
    (width := 2) (op := .PUSH2) (by decide) (by native_decide) (by evm_ov)
  exact ⟨_, _, rd742.jumpiT (by native_decide) one_ne_zero_uint
    (by jump_dest) (by evm_ov)⟩

set_option maxHeartbeats 1000000 in
theorem stairstepRelyX_unauthorized {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
    {sel : UInt256} (hauth : relyAuthWord σ I ≠ ⟨1⟩)
    (h : RD stairstepExponentialDecreaseBytecode I g s0 ⟨719⟩
      [relyUsrMaskedWord I, ⟨165⟩, sel]
      solcFreePtrMem (UInt256.ofNat 3) ByteArray.empty (cA, σ) k C) :
...
theorem stairstepRelyX_storeAuthorized {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
  ...
  have rd864 := RD.log2
    ...
    (by simp only [List.length_cons, List.length_nil]; omega)
  have rd865pre := RD.pop (a := relyUsrMaskedWord I) (t := [⟨165⟩, sel]) rd864
    (by native_decide) (by evm_ov)
  have rd165 := RD.jump (a := ⟨165⟩) (t := [sel]) rd865pre
...
theorem stairstepX_rely_unauthorized {cA gh bl σ σ₀ A I} {g : Sat256} {sel : UInt256}
    (hsz36 : 36 ≤ I.calldata.size) (hsize : I.calldata.size < UInt256.size)
...
theorem stairstepRelyBodyCoreOk
    ...
    (hreach : ∃ k C, RD stairstepExponentialDecreaseBytecode I (Sat256.ofUInt256 g)
      (initState cA gh bl σ_evm σ₀ (Sat256.ofUInt256 g) A I) stairstepRelyEntryPc [sel]
...
theorem stairstepRelyBody {cA gh bl σ_evm σ_solm σ₀ A I} {g : UInt256}
    (hcode : I.code = stairstepExponentialDecreaseBytecode)
    (hsize : I.calldata.size < UInt256.size)
    (hperm : I.perm = true)
    (hwv : I.weiValue = ⟨0⟩)
