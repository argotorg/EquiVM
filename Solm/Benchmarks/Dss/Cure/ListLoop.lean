import Solm.Benchmarks.Dss.Cure.ListBase
...
theorem cureListNonemptyToLoop {cA gh bl σ σ₀ A I} {g : Sat256}
  ...
  have h986 := evm_run h971 with [
    ...
    raw mstore 0 (listArrayHashMem len) (UInt256.ofNat 5)
      (by native_decide) mem_cost (by rfl) (by native_decide) (by evm_ov),
    push1 ⟨32⟩, push1 ⟨0⟩,
    raw keccak256 0 srcsDataSlot (UInt256.ofNat 5) (by native_decide)
      mem_cost (listArrayHashMem_keccak_slot len) (by native_decide) (by evm_ov),
    swap1]
  exact ⟨_, _, by
...
theorem cureListArrayLoopStepToBranch {g : Sat256} {s0 : State}
  ...
  have hmaskLiteral :
      (UInt256.sub (UInt256.shiftLeft (⟨1⟩ : UInt256) ⟨160⟩) ⟨1⟩) =
        solcAddrMask := by
    native_decide
  have rd988 := h.jumpdest (by native_decide) (by evm_ov)
  have rd989 := rd988.dup2 (by native_decide) (by evm_ov)
  obtain ⟨_, _, rd990raw⟩ := rd989.sload (by native_decide) (by evm_ov)
  have rd990 := by
    simpa [solcSlotWord] using rd990raw
  have rd992 := rd990.push1 ⟨1⟩ (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd994 := rd992.push1 ⟨1⟩ (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd996 := rd994.push1 ⟨160⟩ (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd997 := rd996.shl (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd998 := rd997.sub (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd999raw := rd998.and (by native_decide)
    (by simp only [List.length_cons]; omega)
...
theorem cureListArrayCleanup {g : Sat256} {s0 : State}
  ...
  have rd1018 := h.jumpdest (by native_decide) (by evm_ov)
  have rd1019 := rd1018.pop (by native_decide) (by evm_ov)
  have rd1020 := rd1019.pop (by native_decide) (by evm_ov)
  have rd1021 := rd1020.pop (by native_decide) (by evm_ov)
  have rd1022 := rd1021.pop (by native_decide) (by evm_ov)
  have rd1023 := rd1022.pop (by native_decide) (by evm_ov)
  have rd1024 := rd1023.swap1 (by native_decide) (by evm_ov)
  have rd1025 := rd1024.pop (by native_decide) (by evm_ov)
  have rd1026 := rd1025.swap1 (by native_decide) (by evm_ov)
  exact ⟨_, _, rd1026.jump (by native_decide) hret (by evm_ov)⟩
...
theorem cureListArrayLoopStepBack {g : Sat256} {s0 : State}
  ...
  exact ⟨_, _, rd1016.jumpiT (by native_decide) hcond (by jump_dest) (by evm_ov)⟩
...
theorem cureListArrayLoopStepExit {g : Sat256} {s0 : State}
  ...
  obtain ⟨_, _, rd1016⟩ :=
    cureListArrayLoopStepToBranch
      (R := a :: b :: base :: (⟨96⟩ : UInt256) :: ret :: R)
      h (by simp only [List.length_cons]; omega)
  have rd1017 := rd1016.jumpiNT (by native_decide) hcond (by evm_ov)
