...
noncomputable def hashAllocatedMem (I : ExecutionEnv) : ByteArray :=
  (hashNewFreePtr I).toByteArray.write 0 (fallbackPaddedMem I) 64 32

noncomputable def hashCopiedMem (I : ExecutionEnv) : ByteArray :=
...
noncomputable def hashZeroMem (I : ExecutionEnv) : Nat → ByteArray
  | 0 => hashCopiedMem I
  | i + 1 =>
...
noncomputable def hashMarkerMem (I : ExecutionEnv) : ByteArray :=
...
noncomputable def hashPaddedMessageMem (I : ExecutionEnv) : ByteArray :=
...
noncomputable def hashScratchMem (I : ExecutionEnv) : ByteArray :=
