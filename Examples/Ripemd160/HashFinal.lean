import Examples.Ripemd160.HashBridge
...
/-- Leave the block loop, serialize the five little-endian words, and return one raw word. -/
theorem ripemd160X_finish {cA gh bl σ σ₀ A I} {g : Sat256}
  ...
  have rd1028' : RD ripemd160RuntimeBytecode I g
      (initState cA gh bl σ σ₀ g A I) ⟨1028⟩
  ...
  have rd128 := RD.runtimeMstore rd127p (by native_decide) (by simp)
  have rd131 := evm_run rd128 with [push1 ⟨32⟩, push0]
  apply rd131.ret 0 (runtimeDigestValue h).toByteArray (by native_decide)
  · intro s haw hstk
