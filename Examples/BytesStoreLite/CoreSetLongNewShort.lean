import Examples.BytesStoreLite.CoreSetLongNewShortOldShort

/-!
# BytesStoreLiteCore — valid set-branch, new short

This file proves the valid `set(bytes)` branch when the decoded new value is short.
-/
...
theorem bytesStoreLiteCoreSetNewShortRuntime
  ...
  · by_cases hvalid :
      UInt256.sub (UInt256.land (currentLengthHeaderWord σ_evm I) ⟨1⟩)
        (UInt256.lt
          ...
          ⟨32⟩) ≠ ⟨0⟩
    · exact bytesStoreLiteCoreSetNewShortOldShortValidRuntime
    ...
    · exact bytesStoreLiteCoreSetShortNonemptyShortMalformedRuntime
        hcode hsize hperm hwv hsel hAccounts hsz36 hhi hoffMax hlenWord hsizeSign
  ...
  · by_cases hbadLong :
      UInt256.sub (UInt256.land (currentLengthHeaderWord σ_evm I) ⟨1⟩)
        ...
        ⟨0⟩
    · exact bytesStoreLiteCoreSetShortNonemptyLongMalformedRuntime
        hcode hsize hperm hwv hsel hAccounts hsz36 hhi hoffMax hlenWord hsizeSign
        hlenMax hpayload hnewShort hnonzero hflag hbadLong
    · exact bytesStoreLiteCoreSetShortNonemptyLongValidRuntime
        hcode hsize hperm hwv hsel hAccounts hsz36 hhi hoffMax hlenWord hsizeSign
        hlenMax hpayload hnewShort hnonzero hflag hbadLong
