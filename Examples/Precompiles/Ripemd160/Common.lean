import Examples.Precompiles.Ripemd160.Bytecode
import Examples.Precompiles.Ripemd160.HashModel
...
/-!
# Ripemd160Deployed bytecode setup

This module collects the memory layout and byte-level return shape used by the symbolic trace.
-/
...
def fallbackAllocMem (I : ExecutionEnv) : ByteArray :=
  (fallbackFreePtr I).toByteArray.write 0 solcFreePtrMem 64 32

def fallbackLengthMem (I : ExecutionEnv) : ByteArray :=
  (calldataSizeWord I).toByteArray.write 0 (fallbackAllocMem I) 128 32

def fallbackCalldataMem (I : ExecutionEnv) : ByteArray :=
  I.calldata.write 0 (fallbackLengthMem I) 160 I.calldata.size

def fallbackPaddedMem (I : ExecutionEnv) : ByteArray :=
