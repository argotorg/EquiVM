...
//   solc --optimize --evm-version shanghai --bin-runtime Examples/ERC721/ERC721.sol
...
//   * `safeTransferFrom`: its body is `to.code.length == 0 || onERC721Received(...) == selector`,
//     and EXTCODESIZE (`code.length`) is not yet expressible in Solm;
