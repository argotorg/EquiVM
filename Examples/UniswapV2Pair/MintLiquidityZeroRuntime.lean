...
theorem uniswapMintRuntimeLiquidityZeroReverts
  ...
  have hmload64 :
    ...
    mloadFreePtrValue (aw := feeToStaticcallActiveWords)
      (by rw [hmem]; decide) (by decide +native) hmem64
  ...
  have rd3862 := evm_run rd3860 with [
    push1 ⟨229⟩, shl, dup2,
    raw mstore 0 mem0 feeToStaticcallActiveWords (by decide +native)
      mem_cost (by unfold mem0 solcErrorStringSelector; rfl) (by decide +native) (by evm_ov)]
  ...
  have rd3875pre := evm_run rd3862 with [
    ...
    raw mstore 0 mem1 feeToStaticcallActiveWords (by decide +native)
      mem_cost (by unfold mem1; rfl) (by decide +native) (by evm_ov)]
  ...
  have rd3882 := evm_run rd3875pre with [
    ...
    raw mstore 3 mem2 (UInt256.ofNat 7) (by decide +native)
      mem_cost (by unfold mem2; rfl) (by decide +native) (by evm_ov),
    push1 ⟨32⟩, add, dup1]
  ...
  have hmem3 : mem3.size = 236 := by
    unfold mem3
    simpa [hmem2] using
      write_end_size_from uniswapV2PairBytecode mem2 8741 40 (by decide) (by decide +native)
  ...
  have hread64_mem3 : mem3.readWithPadding 64 32 = UInt256.toByteArray ⟨128⟩ := by
    ...
    simpa [hmem2] using
      (write_read_below_end_from uniswapV2PairBytecode mem2 8741 40 64
        (by decide) (by decide +native) (by rw [hmem2]; omega)).trans hread64_mem2
  have hmload64_mem3 :
      (if (⟨64⟩ : UInt256).toNat ≥ mem3.size
        ...
        ⟨128⟩ :=
    mloadWordValue_of_readWithPadding (by rw [hmem3]; decide) (by decide +native)
      hread64_mem3
  have rd3890 := evm_run rd3886 with [
    push1 ⟨40⟩, swap2,
    raw codecopy 3 mem3 (UInt256.ofNat 8) (by decide +native)
      mem_cost (by unfold mem3; rfl) (by decide +native) (by evm_ov)]
  exact evm_run rd3890 with [
    push1 ⟨64⟩, add, swap2, pop, pop, push1 ⟨64⟩,
    raw mload 0 ⟨128⟩ (UInt256.ofNat 8) (by decide +native)
      mem_cost hmload64_mem3 (by decide +native) (by evm_ov),
    dup1, swap2, sub, swap1,
    raw rev 3 (by decide +native) mem_cost (by evm_ov)]
