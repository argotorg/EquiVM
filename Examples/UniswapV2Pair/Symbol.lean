...
theorem uniswapX_symbol {cA gh bl σ σ₀ A I} {g : Sat256} {sel : UInt256}
  ...
  have h5037store := evm_run h5037 with [
    raw mstore 0 symbolObjectMem0 (UInt256.ofNat 3) (by decide +native)
  ...
  have h5042store := evm_run h5042 with [
    raw mstore 6 symbolObjectMem1 (UInt256.ofNat 5) (by decide +native)
      mem_cost (by decide +native) (by decide) (by evm_ov)]
  ...
  have h5058store := evm_run h5058 with [
    raw mstore 3 symbolObjectMem (UInt256.ofNat 6) (by decide +native)
      mem_cost (by decide +native) (by decide) (by evm_ov)]
  ...
  have h590 := evm_run h580 with [
    ...
    raw mload 0 ⟨192⟩ (UInt256.ofNat 6) (by decide +native)
      mem_cost (by decide +native) (by decide) (by evm_ov),
    push1 ⟨32⟩, dup1, dup3,
    raw mstore 3 symbolAbiMem0 (UInt256.ofNat 7) (by decide +native)
      mem_cost (by decide +native) (by decide) (by evm_ov)]
  have h596 := evm_run h590 with [
    dup4,
    raw mload 0 ⟨6⟩ (UInt256.ofNat 7) (by decide +native)
      mem_cost (by decide +native) (by decide) (by evm_ov),
    dup2, dup4, add,
    raw mstore 3 symbolAbiMem1 (UInt256.ofNat 8) (by decide +native)
      mem_cost (by decide +native) (by decide) (by evm_ov)]
  have h614 := evm_run h596 with [
    dup4,
    raw mload 0 ⟨6⟩ (UInt256.ofNat 8) (by decide +native)
      mem_cost (by decide +native) (by decide) (by evm_ov),
  ...
  have h637 := evm_run h623 with [
    dup2, dup2, add,
    raw mload 0 symbolLiteralWord (UInt256.ofNat 8) (by decide +native)
      mem_cost (by decide +native) (by decide) (by evm_ov),
    dup4, dup3, add,
    raw mstore 3 symbolAbiMem2 (UInt256.ofNat 9) (by decide +native)
      mem_cost (by decide +native) (by decide) (by evm_ov),
  ...
  have h683 := evm_run h658 with [
    dup1, dup3, sub, dup1,
    raw mload 0 symbolLiteralWord (UInt256.ofNat 9) (by decide +native)
      mem_cost (by decide +native) (by decide) (by evm_ov),
    push1 ⟨1⟩, dup4, push1 ⟨32⟩, sub, push2 ⟨256⟩, exp, sub, not, and, dup2,
    raw mstore 0 symbolAbiMem3 (UInt256.ofNat 9) (by decide +native)
      mem_cost (by decide +native) (by decide) (by evm_ov),
  ...
  exact evm_run h696 with [
    raw ret 0 symbolReturnBytes (by decide +native)
