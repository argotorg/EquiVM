...
theorem uniswapMintLiquidityMintUpdateElapsedZeroPrefix
    {locals : Store} (evm : EVM.State) (recipient : AccountAddress)
    (balance0 balance1 liquidity : UInt256)
    (hto : locals.get? "to" = some (.address recipient))
    (hliq : locals.get? "liquidity" = some (uniswapUint256Value liquidity))
    (hbalance0 : locals.get? "balance0" = some (uniswapUint256Value balance0))
    (hbalance1 : locals.get? "balance1" = some (uniswapUint256Value balance1))
  ...
  have hupdateStmt :
    ...
    simpa [afterMint] using
      uniswapMintUpdateCallReturns_elapsedZero_packed
        (locals := afterMint.locals)
        (mintFunctionPostState evm recipient liquidity) balance0 balance1
        hbalance0After hbalance1After hreserve0After hreserve1After hbound0 hbound1
        helapsed
  have hupdate :
      ExecBlock config afterMint (mintFunctionPostState evm recipient liquidity)
        ...
        (.ok (resumeAfterInternalCall afterMint "_updateResult" none)
          (syncUpdatePackedReserveState (mintFunctionPostState evm recipient liquidity)
            balance0 balance1)) := by
    simpa [updateReservesStmts] using ExecBlock.consNormal hupdateStmt ExecBlock.nil
...
theorem uniswapMintLiquidityMintUpdateCumulativePrefix
    ...
    (hreserve0 :
      Int.ofNat (uniswapReserve0Word
        (mintFunctionPostState evm recipient liquidity)).toNat ≠ 0)
    (hreserve1 :
    ...
    ExecBlock config { contract := contract, locals := locals } evm
      ...
      (.ok (resumeAfterInternalCall afterMint "_updateResult" none)
        (syncUpdateCumulativePackedReserveState
          (mintFunctionPostState evm recipient liquidity) balance0 balance1)) := by
  intro afterMint
  have hmint :=
    uniswapMintLiquidityMintPrefix (locals := locals) evm recipient liquidity hto hliq
      hliqNonzero hfitSupply hfitBalance
      ...
      ExecStmt config afterMint (mintFunctionPostState evm recipient liquidity)
        ...
        (.ok (resumeAfterInternalCall afterMint "_updateResult" none)
          (syncUpdateCumulativePackedReserveState
            (mintFunctionPostState evm recipient liquidity) balance0 balance1)) := by
    simpa [afterMint] using
      uniswapMintUpdateCallReturns_conditionTrue_packed
        (locals := afterMint.locals)
        (mintFunctionPostState evm recipient liquidity) balance0 balance1
        hbalance0After hbalance1After hreserve0After hreserve1After hbound0 hbound1
  ...
  have htail :
    ...
    simpa [afterBranch, afterMint] using
      uniswapMintLiquidityMintUpdateElapsedZeroPrefix
        (locals := afterBranch.locals) evm recipient balance0 balance1 liquidity htoAfter
        hliqAfter hbalance0After hbalance1After hreserve0BaseAfter hreserve1BaseAfter
  ...
  have htail :
    ...
    simpa [afterBranch, afterMint] using
      uniswapMintLiquidityMintUpdateCumulativePrefix
        (locals := afterBranch.locals) evm recipient balance0 balance1 liquidity htoAfter
        hliqAfter hbalance0After hbalance1After hreserve0BaseAfter hreserve1BaseAfter
        hliqNonzero hfitSupply hfitBalance hbound0 hbound1 helapsed hreserve0Post
        hreserve1Post
  simpa [List.append_assoc] using execBlock_append hbranch htail
...
theorem uniswapMintAfterUpdateFeeOffReturn
  ...
  have hret :
    ...
    ExecBlock.consReturn
      (ExecStmt.return
        (evalExpr_mint_liquidity_of_get
...
theorem uniswapMintLiquidityMintUpdateElapsedZeroFeeOffReturn
  ...
  have hprefix :=
    uniswapMintLiquidityMintUpdateElapsedZeroPrefix (locals := locals) evm recipient
      balance0 balance1 liquidity hto hliq hbalance0 hbalance1 hreserve0Base
      hreserve1Base hliqNonzero hfitSupply hfitBalance hbound0 hbound1 helapsed
  have hfeeAfter :
  ...
  have htail :
    ...
    simpa [afterBranch, afterMint, afterUpdate] using
      uniswapMintLiquidityMintUpdateElapsedZeroFeeOffReturn
        (locals := afterBranch.locals) evm recipient balance0 balance1 liquidity htoAfter
        hliqAfter hbalance0After hbalance1After hfeeOnAfter hreserve0BaseAfter
  ...
  have htail :
    ...
    simpa [afterBranch, afterMint, afterUpdate] using
      uniswapMintLiquidityMintUpdateCumulativeFeeOffReturn
        ...
        hliqAfter hbalance0After hbalance1After hfeeOnAfter hreserve0BaseAfter
        hreserve1BaseAfter hunlockedBaseAfter hliqNonzero hfitSupply hfitBalance hbound0
        hbound1 helapsed hreserve0Post hreserve1Post
  simpa [List.append_assoc] using execBlock_append hbranch htail
  ...
  have htail :
    ...
    simpa [afterBranch, afterMint, afterUpdate] using
      uniswapMintLiquidityMintUpdateCumulativeFeeOnReturn
        ...
        hliqAfter hbalance0After hbalance1After hfeeOnAfter hreserve0BaseAfter
        hreserve1BaseAfter hkLastBaseAfter hunlockedBaseAfter hliqNonzero hfitSupply
        hfitBalance hbound0 hbound1 helapsed hreserve0Post hreserve1Post hfitKLast
  simpa [List.append_assoc] using execBlock_append hbranch htail
  ...
  · have hroot :
        (resumeAfterInternalCall caller "rootLiquidity"
          (some (sqrtFunctionSmallResultValue y))).locals.get? "rootLiquidity" =
            some (.int 0) := by
      simp [resumeAfterInternalCall, sqrtFunctionSmallResultValue, hy]
