...
-- PROMOTE -> Storage.lean: consolidate with the same full-slot BlindAuction uint256 load in Bids.lean.
...
theorem blindAuctionDispatch_biddingEnd {cd : ByteArray}
  ...
  refine dispatchMsg_eq_some_of_split
    ...
    rfl ?_ (by rw [selectorOf, blindAuctionBiddingEndSelectorBytes]; exact hsel)
  intro t ht
