...
theorem powLoopCore {g : UInt256} {s0 : State} {slot n : UInt256} {REST : List UInt256} (hn : n.toNat < 256)
  ...
  | zero =>
    ...
    · set s1 := stJumpdest s with hs1
      ...
      have st1 := dup4_xstep hc1 hp1 (by decide) hk1 (by first | (simp only [List.length_append, List.length_cons, List.length_nil]; omega) | omega)
      ...
      · set s2 := stSwap s1 (n :: i :: r :: slot :: n :: REST) with hs2
        ...
        have st2 := dup2_xstep hc2 hp2 (by decide) hk2 (by first | (simp only [List.length_append, List.length_cons, List.length_nil]; omega) | omega)
        ...
        · set s3 := stSwap s2 (i :: n :: i :: r :: slot :: n :: REST) with hs3
          ...
          have st3 := lt_xstep hc3 hp3 (by decide) hk3 (by first | (simp only [List.length_append, List.length_cons, List.length_nil]; omega) | omega)
          ...
          · set s4 := stBinop s3 (UInt256.lt i n) (i :: r :: slot :: n :: REST) with hs4
            ...
            have st4 := iszero_xstep hc4 hp4 (by decide) hk4 (by first | (simp only [List.length_append, List.length_cons, List.length_nil]; omega) | omega)
            ...
            · set s5 := stIsZero s4 ⟨0⟩ (i :: r :: slot :: n :: REST) with hs5
              ...
              have st5 := push2_xstep (argv:=⟨142⟩) hc5 hp5 (by decide) hk5 (by first | (simp only [List.length_append, List.length_cons, List.length_nil]; omega) | omega)
              ...
              · set s6 := stPush2 s5 ⟨142⟩ with hs6
                ...
                have st6 := jumpi_t_xstep hc6 hp6 (by decide) hk6 (by decide)
                  (by rw [powValidJumps]; exact Array.contains_eq_true_of_mem (by simp)) (by first | (simp only [List.length_append, List.length_cons, List.length_nil]; omega) | omega)
            ...
            · set s5 := stIsZero s4 ⟨1⟩ (i :: r :: slot :: n :: REST) with hs5
              ...
              · set s6 := stPush2 s5 ⟨142⟩ with hs6
                ...
                have hk6 : s6.machineState.stack = (⟨142⟩ :: ⟨0⟩ :: i :: r :: slot :: n :: REST) := by
                  rw [hs6]; simp only [stPush2, hk5]
                have st6 := jumpi_nt_xstep hc6 hp6 (by decide) hk6 (by first | (simp only [List.length_append, List.length_cons, List.length_nil]; omega) | omega)
                by_cases g6 : g.toNat < C + 26
                · exact Or.inl (hX6.trans (stepOOG (k:=k+6) (C:=C+16) (cost:=10) hg6 st6 (by omega) (by omega) (by omega)))
                · set s7 := stJumpiNT s6 (i :: r :: slot :: n :: REST) with hs7
                  ...
                  have st7 := push1_xstep (argv:=⟨2⟩) hc7 hp7 (by decide) hk7 (by first | (simp only [List.length_append, List.length_cons, List.length_nil]; omega) | omega)
                  ...
                  · set s8 := stPush1 s7 ⟨2⟩ with hs8
                    ...
                    have st8 := dup3_xstep hc8 hp8 (by decide) hk8 (by first | (simp only [List.length_append, List.length_cons, List.length_nil]; omega) | omega)
                    ...
                    · set s9 := stSwap s8 (r :: ⟨2⟩ :: i :: r :: slot :: n :: REST) with hs9
                      ...
                      have st9 := mul_xstep hc9 hp9 (by decide) hk9 (by first | (simp only [List.length_append, List.length_cons, List.length_nil]; omega) | omega)
                      ...
                      · set s10 := stMul s9 (UInt256.mul r ⟨2⟩) (i :: r :: slot :: n :: REST) with hs10
                        ...
                        have st10 := swap2_xstep hc10 hp10 (by decide) hk10 (by first | (simp only [List.length_append, List.length_cons, List.length_nil]; omega) | omega)
                        ...
                        · set s11 := stSwap s10 (r :: i :: UInt256.mul r ⟨2⟩ :: slot :: n :: REST) with hs11
                          ...
                          have st11 := pop_xstep hc11 hp11 (by decide) hk11 (by first | (simp only [List.length_append, List.length_cons, List.length_nil]; omega) | omega)
                          ...
                          · set s12 := stPop s11 (i :: UInt256.mul r ⟨2⟩ :: slot :: n :: REST) with hs12
                            ...
                            have st12 := push1_xstep (argv:=⟨1⟩) hc12 hp12 (by decide) hk12 (by first | (simp only [List.length_append, List.length_cons, List.length_nil]; omega) | omega)
                            ...
                            · set s13 := stPush1 s12 ⟨1⟩ with hs13
                              ...
                              have st13 := dup2_xstep hc13 hp13 (by decide) hk13 (by first | (simp only [List.length_append, List.length_cons, List.length_nil]; omega) | omega)
                              ...
                              · set s14 := stSwap s13 (i :: ⟨1⟩ :: i :: UInt256.mul r ⟨2⟩ :: slot :: n :: REST) with hs14
                                ...
                                have st14 := add_xstep hc14 hp14 (by decide) hk14 (by first | (simp only [List.length_append, List.length_cons, List.length_nil]; omega) | omega)
                                ...
                                · set s15 := stBinop s14 (i + ⟨1⟩) (i :: UInt256.mul r ⟨2⟩ :: slot :: n :: REST) with hs15
                                  ...
                                  have st15 := swap1_xstep hc15 hp15 (by decide) hk15 (by first | (simp only [List.length_append, List.length_cons, List.length_nil]; omega) | omega)
                                  ...
                                  · set s16 := stSwap s15 (i :: (i + ⟨1⟩) :: UInt256.mul r ⟨2⟩ :: slot :: n :: REST) with hs16
                                    ...
                                    have st16 := pop_xstep hc16 hp16 (by decide) hk16 (by first | (simp only [List.length_append, List.length_cons, List.length_nil]; omega) | omega)
                                    ...
                                    · set s17 := stPop s16 ((i + ⟨1⟩) :: UInt256.mul r ⟨2⟩ :: slot :: n :: REST) with hs17
                                      ...
                                      have st17 := push2_xstep (argv:=⟨117⟩) hc17 hp17 (by decide) hk17 (by first | (simp only [List.length_append, List.length_cons, List.length_nil]; omega) | omega)
