...
/-- `EVMStateEquiv`-returning form of raw low-level call transport, generic over the `callPerm`
    flag. -/
...
/-- `EVMStateEquiv`-returning form of raw low-level call transport at the default call
    permission. -/
