...
theorem daiX_symbol_ok {cA gh bl σ σ₀ A I} {g : Sat256} {sel : UInt256}
  ...
  have h350 := evm_run h344 with [
    dup4,
    raw mload 0 daiSymbolLen (UInt256.ofNat 7) (by decide +native)
      mem_cost (by decide +native) (by decide) (by evm_ov),
    dup2, dup4, add,
  ...
  have h367 := evm_run h350 with [
    dup4,
    raw mload 0 daiSymbolLen (UInt256.ofNat 8) (by decide +native)
      mem_cost (by decide +native) (by decide) (by evm_ov),
  ...
  have h393a := evm_run h378 with [
    dup2, dup2, add,
    raw mload 0 daiSymbolLiteralWord (UInt256.ofNat 8) (by decide +native)
      mem_cost (by decide +native) (by decide) (by evm_ov),
    dup4, dup3, add,
  ...
  have h438 := evm_run h413 with [
    dup1, dup3, sub, dup1,
    raw mload 0 daiSymbolLiteralWord (UInt256.ofNat 9) (by decide +native)
      mem_cost (by decide +native) (by decide) (by evm_ov),
  ...
  exact evm_run h451 with [
    raw ret 0 daiSymbolReturnBytes (by decide +native)
...
theorem daiSymbolBodyCore {cA gh bl σ_evm σ_solm σ₀ A I} {g : UInt256}
  ...
  have hsz4 : 4 ≤ I.calldata.size :=
    calldata_size_ge_of_selIs I (daiSelBytes 16) (by decide +native) hsel
