...
theorem RD.stairstepFileDecodeToRoutine {cA σ I} {g : Sat256} {s0 : State}
  ...
  have rd350 := evm_run h with [
    ...
    raw calldataload (by decide +native) (by evm_ov),
    raw push2 ⟨350⟩ (by decide +native) (by evm_ov),
...
theorem stairstepFileX_cut_ok {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
  ...
  have rd443pre := evm_run rd437pre with [
    ...
    raw push2 ⟨527⟩ (by decide +native) (by evm_ov),
...
theorem stairstepFileX_step_ok {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
  ...
  have rd537pre := evm_run rd534 with [
    raw push1 ⟨228⟩ (by decide +native) (by evm_ov),
    raw shl (by decide +native) (by evm_ov),
    raw eq (by decide +native) (by evm_ov)]
  ...
  have rd543 := evm_run rd537pre with [
    ...
    raw dup2 (by decide +native) (by evm_ov),
    raw swap1 (by decide +native) (by evm_ov)]
  obtain ⟨k548, C548, rd548raw⟩ := rd543.sstore hperm (by decide +native)
    (by simp only [List.length_cons, List.length_nil]; omega)
