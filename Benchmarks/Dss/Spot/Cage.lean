...
theorem spotCageX_enter {cA gh bl σ σ₀ A I} {g : Sat256} {sel : UInt256}
  ...
  have rd396 := rd393.push2 ⟨214⟩ (by decide +native) (by evm_ov)
  have rd399 := rd396.push2 ⟨1579⟩ (by decide +native) (by evm_ov)
...
theorem spotCageX_storeAuthorized {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
    ...
    RDret spotBytecode g s0
      ...
      ByteArray.empty := by
  have rd1662 := h.jumpdest (by decide +native) (by evm_ov)
  have rd1664 := rd1662.push1 ⟨0⟩ (by decide +native) (by evm_ov)
  have rd1666 := rd1664.push1 ⟨4⟩ (by decide +native) (by evm_ov)
  obtain ⟨_, _, rd1667raw⟩ := rd1666.sstore hperm (by decide +native) (by evm_ov)
  have rd214 := rd1667raw.jump (by decide +native) (by jump_dest) (by evm_ov)
