...
per-site wrappers below discharge the two decode facts by `decide +native` at their concrete `pc`. -/
...
theorem catBiteReachGuardArtRate {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  exact RD.catBiteReachMul3720Tail rd1538 (by decide +native) (by decide +native)
...
theorem catBiteReachGuardInkSpot {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  exact RD.catBiteReachMul3720Tail rd1548 (by decide +native) (by decide +native)
    (by simp only [List.length_cons]; omega)
...
theorem catBiteReachGuardDunkRoomWad {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  exact RD.catBiteReachMul3720Tail rd1838 (by decide +native) (by decide +native) (by evm_ov)
...
theorem catBiteReachGuardInkDart {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  exact RD.catBiteReachMul3720Tail rd1888 (by decide +native) (by decide +native) (by evm_ov)
...
theorem catBiteReachGuardDartRate {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  exact RD.catBiteReachMul3720Tail rd2238 (by decide +native) (by decide +native) (by evm_ov)
...
theorem catBiteReachGuardTabBase {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  have rd2349 := RD.mload 0 milkChop aw rd2348 (by decide +native) (catBiteMloadCost0 hChopAw)
    hChop hChopAw (by evm_ov)
  exact RD.catBiteReachMul3720Tail rd2349 (by decide +native) (by decide +native) (by evm_ov)
...
theorem catBiteReachGuardRoomSub {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  exact ⟨_, _, rd1707.jump (by decide +native) (by jump_dest) (by evm_ov)⟩
...
theorem catBiteReachGuardMilkChopZero {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  exact ⟨_, _, rd1864.jumpiNT (by decide +native) hChopZero (by evm_ov)⟩
...
theorem catBiteReachGuardLive {cA gh bl σ σ₀ A I} {g : UInt256}
    ...
    ∃ k' C', RD catBytecode I (Sat256.ofUInt256 g)
      ...
      (UInt256.eq ⟨1⟩ (catSlotWord ⟨2⟩ σ' I) :: art :: ink :: iDust :: iSpot :: iRate :: ⟨0⟩ ::
        urn :: ilk :: R)
      mem aw o (cA', σ') k' C' := by
  have rd1449 := rd.push1 ⟨2⟩ (by decide +native) (by evm_ov)
  obtain ⟨k1450, C1450, rd1450raw⟩ := rd1449.sload (by decide +native) (by evm_ov)
  ...
  have rd1451 := rd1450.swap2 (by decide +native) (by evm_ov)
  have rd1452 := rd1451.swap4 (by decide +native) (by evm_ov)
  have rd1453 := rd1452.pop (by decide +native) (by evm_ov)
  have rd1454 := rd1453.swap2 (by decide +native) (by evm_ov)
  have rd1455 := rd1454.pop (by decide +native) (by evm_ov)
  have rd1457 := rd1455.push1 ⟨1⟩ (by decide +native) (by evm_ov)
  exact ⟨_, _, rd1457.eq (by decide +native) (by evm_ov)⟩
...
theorem catBiteReachGuardUnsafe {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  exact ⟨_, _, rd1554.jumpdest (by decide +native) (by simp only [List.length_cons]; omega)⟩
...
theorem catBiteReachGuardRoomDust {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  exact ⟨_, _, rd1729.jumpdest (by decide +native) (by evm_ov)⟩
...
theorem catBiteReachGuardDinkPos {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  exact ⟨_, _, rd1917.jumpdest (by decide +native) (by evm_ov)⟩
...
theorem catBiteReachGuardDinkLimit {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  exact ⟨_, _, rd2009.jumpdest (by decide +native) (by evm_ov)⟩
...
theorem catBiteReachGuardSpot {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  have rd1525 := rd1524.dup5 (by decide +native) (by simp only [List.length_cons]; omega)
  have rd1526 := rd1525.gt (by decide +native) (by simp only [List.length_cons]; omega)
  rw [show UInt256.gt iSpot ⟨0⟩ = ⟨0⟩ from by rw [hSpotZero]; decide +native] at rd1526
  have rd1527 := rd1526.dup1 (by decide +native) (by simp only [List.length_cons]; omega)
  have rd1528 := rd1527.iszero (by decide +native) (by simp only [List.length_cons]; omega)
  rw [show UInt256.isZero (⟨0⟩ : UInt256) = ⟨1⟩ from by decide +native] at rd1528
  have rd1531 := rd1528.push2 ⟨1554⟩ (by decide +native) (by simp only [List.length_cons]; omega)
  have rd1554 := rd1531.jumpiT (by decide +native) one_ne_zero_uint (by jump_dest)
    (by simp only [List.length_cons]; omega)
  exact ⟨_, _, rd1554.jumpdest (by decide +native) (by simp only [List.length_cons]; omega)⟩
...
theorem catBiteReachGuardLitter {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  have rd1719 := rd1718.dup1 (by decide +native) (by evm_ov)
  have rd1720 := rd1719.iszero (by decide +native) (by evm_ov)
  rw [show UInt256.isZero (⟨0⟩ : UInt256) = ⟨1⟩ from by decide +native] at rd1720
  have rd1723 := rd1720.push2 ⟨1729⟩ (by decide +native) (by evm_ov)
  have rd1729 := rd1723.jumpiT (by decide +native) one_ne_zero_uint (by jump_dest) (by evm_ov)
  exact ⟨_, _, rd1729.jumpdest (by decide +native) (by evm_ov)⟩
...
theorem catBiteReachGuardDartPos {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  have rd1905 := rd1904.dup3 (by decide +native) (by evm_ov)
  have rd1906 := rd1905.gt (by decide +native) (by evm_ov)
  rw [show UInt256.gt dart ⟨0⟩ = ⟨0⟩ from by rw [hDartZero]; decide +native] at rd1906
  have rd1907 := rd1906.dup1 (by decide +native) (by evm_ov)
  have rd1908 := rd1907.iszero (by decide +native) (by evm_ov)
  rw [show UInt256.isZero (⟨0⟩ : UInt256) = ⟨1⟩ from by decide +native] at rd1908
  have rd1911 := rd1908.push2 ⟨1917⟩ (by decide +native) (by evm_ov)
  have rd1917 := rd1911.jumpiT (by decide +native) one_ne_zero_uint (by jump_dest) (by evm_ov)
  exact ⟨_, _, rd1917.jumpdest (by decide +native) (by evm_ov)⟩
...
theorem catBiteReachGuardDartLimit {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  have rd1994 := rd1993.iszero (by decide +native) (by evm_ov)
  rw [show UInt256.isZero (⟨1⟩ : UInt256) = ⟨0⟩ from by decide +native] at rd1994
  have rd1995 := rd1994.dup1 (by decide +native) (by evm_ov)
  have rd1996 := rd1995.iszero (by decide +native) (by evm_ov)
  rw [show UInt256.isZero (⟨0⟩ : UInt256) = ⟨1⟩ from by decide +native] at rd1996
  have rd1999 := rd1996.push2 ⟨2009⟩ (by decide +native) (by evm_ov)
  have rd2009 := rd1999.jumpiT (by decide +native) one_ne_zero_uint (by jump_dest) (by evm_ov)
  exact ⟨_, _, rd2009.jumpdest (by decide +native) (by evm_ov)⟩
