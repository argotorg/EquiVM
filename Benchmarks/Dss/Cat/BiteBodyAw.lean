...
theorem catBiteReachPostIlksAw {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  obtain ⟨gasWord, _, _, rd1248⟩ := RD.solcExtcodesizeGuardOkGas (pc := ⟨1233⟩) (okPc := ⟨1245⟩)
    rd1233 hcodeSize (by decide +native) (by decide +native) (by decide +native) (by decide +native)
    (by decide +native) (by decide +native) (by decide +native) (by decide +native)
    (by decide +native) (by decide +native) (by simp)
  obtain ⟨cA', σ', z, o', A_in, callGas, k', C', hΘpack, rd1249, hosz⟩ :=
    RD.solcStaticcall rd1248 (by decide +native) hdepth (by simp)
  obtain ⟨g'', A', hΘ⟩ := hΘpack
  refine ⟨cA', σ', z, o', A', _, k', C', rd1249, ?_, hosz, by decide +native, by decide +native⟩
...
theorem catBiteReachPostUrnsAw {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  obtain ⟨cA'', σ'', z, o', A_in, callGas, k', C', hΘpack, rd1399, hosz'⟩ :=
    RD.solcStaticcall rd1398 (by decide +native) hdepth
...
theorem catBiteTraceGrabBuildAw {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  have rd2094 := RD.mstore _ (catBiteGrabSelMemP p mem) (catBiteAwStepL aw p.toNat) rd2094d
    (by decide +native) catBiteMstoreCostML rfl hstep1 (by evm_ov)
  ...
  have rd2100 := RD.mstore _ (catBiteGrabIlkMemP p ilk mem) (catBiteAwStepL aw (p + ⟨4⟩).toNat) rd2099
    (by decide +native) catBiteMstoreCostML rfl hcol2 (by evm_ov)
  ...
  have rd2116 := RD.mstore _ (catBiteGrabUrnMemP p ilk urn mem) (catBiteAwStepL aw (p + ⟨36⟩).toNat)
    rd2115 (by decide +native) catBiteMstoreCostML rfl hcol3 (by evm_ov)
  ...
  have rd2122 := RD.mstore _ (catBiteGrabThisMemP p ilk urn (UInt256.ofNat I.codeOwner.val) mem)
    (catBiteAwStepL aw (p + ⟨68⟩).toNat) rd2121 (by decide +native) catBiteMstoreCostML rfl hcol4
    (by evm_ov)
  ...
  have rd2130 := RD.mstore _
    ...
    (catBiteAwStepL aw (p + ⟨100⟩).toNat) rd2129 (by decide +native) catBiteMstoreCostML rfl hcol5
    (by evm_ov)
  ...
  have rd2140 := RD.mstore _
    ...
    (catBiteAwStepL aw (p + ⟨132⟩).toNat) rd2139 (by decide +native) catBiteMstoreCostML rfl hcol6
    (by evm_ov)
  ...
  have rd2148 := RD.mstore _
    (catBiteGrabCalldataMemP p ilk urn (UInt256.ofNat I.codeOwner.val) (solcSlotWord σ' I ⟨4⟩)
      dink dart mem) (catBiteAwStepL aw (p + ⟨164⟩).toNat) rd2147 (by decide +native) catBiteMstoreCostML
    rfl hcol7 (by evm_ov)
  have rd2149 := rd2148.swap1 (by decide +native) (by evm_ov)
  have rd2150 := RD.mload 0 p (catBiteAwStepL aw (p + ⟨164⟩).toNat) rd2149 (by decide +native)
  ...
  exact ⟨_, _, rd2175.dup1 (by decide +native) (by evm_ov)⟩
...
theorem catBiteTraceFessBuildAw {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  have rd2257 := RD.mstore _ (catBiteFessSelMemP p2 mem) (catBiteAwStepL aw p2.toNat) rd2257d
    (by decide +native) catBiteMstoreCostML rfl hstepF1 (by evm_ov)
  ...
  have rd2264 := RD.mstore _ (catBiteFessCalldataMemP p2 dartRate mem)
    (catBiteAwStepL aw (⟨4⟩ + p2).toNat) rd2263 (by decide +native) catBiteMstoreCostML rfl hcolF2
    (by evm_ov)
  ...
  have rd2275 := RD.mload 0 p2 (catBiteAwStepL aw (⟨4⟩ + p2).toNat) rd2273 (by decide +native)
  ...
  exact ⟨_, _, rd2282.dup1 (by decide +native) (by evm_ov)⟩
