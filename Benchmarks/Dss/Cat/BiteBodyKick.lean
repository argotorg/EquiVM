...
theorem catBiteKickCalldataP {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  have a36 : (⟨32⟩ : UInt256) + (p + ⟨4⟩) = p + ⟨36⟩ := by
    rw [← u256_add_assoc, u256_add_comm ⟨32⟩ p, u256_add_assoc,
      show (⟨32⟩ : UInt256) + ⟨4⟩ = ⟨36⟩ from by decide +native]
  have a68 : (⟨32⟩ : UInt256) + (p + ⟨36⟩) = p + ⟨68⟩ := by
    rw [← u256_add_assoc, u256_add_comm ⟨32⟩ p, u256_add_assoc,
      show (⟨32⟩ : UInt256) + ⟨36⟩ = ⟨68⟩ from by decide +native]
  have a100 : (⟨32⟩ : UInt256) + (p + ⟨68⟩) = p + ⟨100⟩ := by
    rw [← u256_add_assoc, u256_add_comm ⟨32⟩ p, u256_add_assoc,
      show (⟨32⟩ : UInt256) + ⟨68⟩ = ⟨100⟩ from by decide +native]
  have a132 : (⟨32⟩ : UInt256) + (p + ⟨100⟩) = p + ⟨132⟩ := by
    rw [← u256_add_assoc, u256_add_comm ⟨32⟩ p, u256_add_assoc,
      show (⟨32⟩ : UInt256) + ⟨100⟩ = ⟨132⟩ from by decide +native]
  have a164 : (⟨32⟩ : UInt256) + (p + ⟨132⟩) = p + ⟨164⟩ := by
    rw [← u256_add_assoc, u256_add_comm ⟨32⟩ p, u256_add_assoc,
      show (⟨32⟩ : UInt256) + ⟨132⟩ = ⟨164⟩ from by decide +native]
  ...
  have rd2432 := RD.mload 0 p aw rd2431 (by decide +native) (mloadCost0 hM64) hFree hM64 (by evm_ov)
  ...
  have rd2444 := RD.mstore 0 (kickSelectorMemP p mem) aw rd2443 (by decide +native) (mstoreCost0 hMp)
  ...
  have rd2460 := RD.mstore 0 ((UInt256.land biteAddrMaskWord urn).toByteArray.write 0
      (kickSelectorMemP p mem) (p + ⟨4⟩).toNat 32) aw rd2459 (by decide +native) (mstoreCost0 hMp4)
  ...
  have rd2475 := RD.mstore 0 ((UInt256.land biteAddrMaskWord
      ...
      ((UInt256.land biteAddrMaskWord urn).toByteArray.write 0 (kickSelectorMemP p mem) (p + ⟨4⟩).toNat 32)
        (p + ⟨36⟩).toNat 32)
      aw rd2474 (by decide +native) (mstoreCost0 hMp36) (by rfl) hMp36 (by evm_ov)
  ...
  have rd2481 := RD.mstore 0 _ aw rd2480 (by decide +native) (mstoreCost0 hMp68) (by rfl) hMp68 (by evm_ov)
  ...
  have rd2487 := RD.mstore 0 _ aw rd2486 (by decide +native) (mstoreCost0 hMp100) (by rfl) hMp100 (by evm_ov)
  ...
  have rd2493 := RD.mstore 0 (kickCalldataMemP p (UInt256.land biteAddrMaskWord urn)
        (UInt256.land biteAddrMaskWord (UInt256.land biteAddrMaskWord
          (UInt256.div (solcSlotWord σx I ⟨4⟩) (UInt256.exp ⟨256⟩ ⟨0⟩)))) tab dink mem)
      aw rd2492 (by decide +native) (mstoreCost0 hMp132) (by rfl) hMp132 (by evm_ov)
  ...
  have rd2508 := RD.mload 0 p aw rd2507 (by decide +native) (mloadCost0 hM64) hval2 hM64 (by evm_ov)
...
theorem catBiteKickGuardCallP {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  obtain ⟨cA', σ', z, o', A_in, callGas, k', C', hΘpack, rd2532raw, hosz⟩ :=
    RD.call rd2531 (by decide +native) hdepth (by omega)
  obtain ⟨g'', A', hΘ⟩ := hΘpack
  have hpc : ((⟨2528⟩ : UInt256) + ⟨1⟩ + ⟨1⟩ + ⟨1⟩ + ⟨1⟩) = (⟨2532⟩ : UInt256) := by decide +native
  rw [hpc] at rd2532raw
...
theorem catBiteKickSeg8b1P {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  have rd2556 := RD.mload 0 p aw8 rd2555 (by decide +native) (mloadCost0 hM64) hFree8 hM64 (by evm_ov)
  ...
  have rd2573 := RD.mload 0 id aw8 rd2572 (by decide +native) (mloadCost0 hMp) hId8 hMp (by evm_ov)
...
theorem catBiteKickSeg8b2P {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  have rd2637 := RD.mload 0 p aw8 rd2636 (by decide +native) (mloadCost0 hM64) hFree8 hM64 (by evm_ov)
  have rd2638 := rd2637.swap5 (by decide +native) (by evm_ov)
  have rd2639 := rd2638.dup6 (by decide +native) (by evm_ov)
  have rd2640 := RD.mstore 0 _ aw8 rd2639 (by decide +native) (mstoreCost0 hMp) (by rfl) hMp (by evm_ov)
  ...
  have rd2648 := RD.mstore 0 _ aw8 rd2647 (by decide +native) (mstoreCost0 hMp32) (by rfl) hMp32 (by evm_ov)
  ...
  have rd2655 := RD.mstore 0 _ aw8 rd2654 (by decide +native) (mstoreCost0 hMp64) (by rfl) hMp64 (by evm_ov)
  ...
  have rd2669 := RD.mstore 0 _ aw8 rd2668 (by decide +native) (mstoreCost0 hMp96) (by rfl) hMp96 (by evm_ov)
  ...
  have rd2676 := RD.mstore 0 _ aw8 rd2675 (by decide +native) (mstoreCost0 hMp128) (by rfl) hMp128 (by evm_ov)
  ...
  have rd2677 := RD.mload 0 p aw8 rd2676 (by decide +native) (mloadCost0 hM64) hFreeEv hM64 (by evm_ov)
  ...
  have rd424 := RD.mload 0 p aw8 rd423 (by decide +native) (mloadCost0 hM64) hFreeEv hM64 (by evm_ov)
  have rd425 := rd424.swap2 (by decide +native) (by evm_ov)
  have rd426 := rd425.dup3 (by decide +native) (by evm_ov)
  have rd427 := RD.mstore 0 _ aw8 rd426 (by decide +native) (mstoreCost0 hMp) (by rfl) hMp (by evm_ov)
  ...
  have rd428 := RD.mload 0 p aw8 rd427 (by decide +native) (mloadCost0 hM64) hFreeM2 hM64 (by evm_ov)
...
theorem catBiteReachKickC {cA gh bl σ σ₀ A I} {g : UInt256}
  ...
  obtain ⟨cA', σ', z, o', A_in, callGas, k', C', hΘpack, rd2532raw, hosz⟩ :=
    RD.call rd2531 (by decide +native) hdepth (by simp only [List.length_cons, List.length_nil]; omega)
  obtain ⟨g'', A', hΘ⟩ := hΘpack
  have hpc : ((⟨2528⟩ : UInt256) + ⟨1⟩ + ⟨1⟩ + ⟨1⟩ + ⟨1⟩) = (⟨2532⟩ : UInt256) := by decide +native
  rw [hpc] at rd2532raw
