...
theorem RD.catFileUintDecodeToRoutine {code : ByteArray} {g : Sat256} {s0 : State}
  ...
  subst hwf
  have rd327 := h.jumpdest (by decide +native) (by evm_ov)
  have rd328 := rd327.pop (by decide +native) (by evm_ov)
  have rd329 := rd328.dup1 (by decide +native) (by evm_ov)
  have rd330 := rd329.calldataload (by decide +native) (by evm_ov)
  have rd331 := rd330.swap1 (by decide +native) (by evm_ov)
  have rd333 := rd331.push1 ⟨32⟩ (by decide +native) (by evm_ov)
  have rd334 := rd333.add (by decide +native) (by evm_ov)
  have rd335 := rd334.calldataload (by decide +native) (by evm_ov)
  have rd338 := rd335.push2 ⟨1035⟩ (by decide +native) (by evm_ov)
  exact ⟨_, _, by
    simpa [calldataWord, show (⟨4⟩ : UInt256).toNat = 4 from by decide,
      show (⟨36⟩ : UInt256).toNat = 36 from by decide]
      using rd338.jump (by decide +native) hroutine (by evm_ov)⟩
...
theorem RD.catFileUintStoreBox {g : Sat256} {s0 : State} {ee : ExecutionEnv}
  ...
  have rd1125 := h.jumpdest (by decide +native) (by evm_ov)
  have rd1126 := rd1125.dup2 (by decide +native) (by evm_ov)
  have rd1130 := rd1126.pushConst (⟨806383⟩ : UInt256) (width := 3) (op := .PUSH3)
    (by decide) (by decide +native) (by evm_ov)
  have rd1132 := rd1130.push1 ⟨235⟩ (by decide +native) (by evm_ov)
  have rd1133 := rd1132.shl (by decide +native) (by evm_ov)
  have hconst : UInt256.shiftLeft ⟨806383⟩ ⟨235⟩ = ABI.bytesToWord fileUintBoxBytes := by
    decide +native
  rw [hmatch, ← hconst] at rd1133
  have rd1134 := rd1133.eq (by decide +native) (by evm_ov)
  rw [uInt256_eq_self] at rd1134
  have rd1135 := rd1134.iszero (by decide +native) (by evm_ov)
  rw [show UInt256.isZero (⟨1⟩ : UInt256) = ⟨0⟩ from by decide] at rd1135
  have rd1138 := rd1135.push2 ⟨953⟩ (by decide +native) (by evm_ov)
  have rd1139 := rd1138.jumpiNT (by decide +native)
    (by decide : (⟨0⟩ : UInt256) = ⟨0⟩) (by evm_ov)
  have rd1141 := rd1139.push1 ⟨5⟩ (by decide +native) (by evm_ov)
  have rd1142 := rd1141.dup2 (by decide +native) (by evm_ov)
  have rd1143 := rd1142.swap1 (by decide +native) (by evm_ov)
  obtain ⟨_, _, rd1144⟩ := rd1143.sstore hperm (by decide +native) (by evm_ov)
...
theorem RD.catFileUintSkipBox {g : Sat256} {s0 : State} {ee : ExecutionEnv}
  ...
  have rd1138 := rd1135.push2 ⟨953⟩ (by decide +native) (by evm_ov)
  exact ⟨_, _, rd1138.jumpiT (by decide +native) one_ne_zero_uint (by jump_dest)
    (by evm_ov)⟩
...
theorem RD.catFileUintUnrecognizedParamRevert
  ...
  have hboxNe :
      calldataWord I.calldata 4 ≠ ABI.bytesToWord fileUintBoxBytes :=
    fileUintWhatWord_ne_of_bytes_ne (by omega) hnotBox (by decide +native)
...
theorem catFileUintBody {cA gh bl σ_evm σ_solm σ₀ A I} {g : UInt256}
  ...
  have hsz : 4 ≤ I.calldata.size :=
    calldata_size_ge_of_selIs I ⟨#[0x29, 0xae, 0x81, 0x14]⟩ (by decide +native) hsel
