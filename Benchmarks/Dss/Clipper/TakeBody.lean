                                            ...
                                            · have hvatCode :
                                              ...
                                              · have hzVatTrue : zVat = true := by
                                                ...
                                                · obtain ⟨k4414, C4414, rd4414⟩ :=
                                                    RD.clipperTakeOweGtTabVatFluxCallSuccessToPostGuard
                                                      (v := v) (hpatch := hpatch) rdVat
                                                      hzVatTrue (by
                                                        simp only [List.length_cons,
                                                          List.length_nil]
                                                        omega)
                                                  by_cases hwhoVat :
                                                      UInt256.land (clipperTakeWhoWord I)
                                                          solcAddrMask =
                                                        clipperTakeVatTarget v
                                                  · sorry
                                                  · by_cases hwhoDog :
                                                        UInt256.land (clipperTakeWhoWord I)
                                                          ...
                                                          UInt256.land
                                                            ...
                                                            solcAddrMask
                                                    · sorry
                                                    · obtain ⟨k4530, C4530, rd4530⟩ :=
                                                        RD.clipperTakeClipperCallGuardTrue
                                                          (v := v) (hpatch := hpatch)
                                                          rd4414 hdataLen hwhoVat hwhoDog
                                                          (by
                                                            simp only [List.length_cons,
                                                              List.length_nil]
                                                            omega)
                                                      ...
                                                      have hpayloadEnd :
                                                          32 +
                                                              ...
                                                              (clipperTakeDataLenWord I).toNat ≤
                                                            I.calldata.size :=
                                                        clipperTakePayloadEnd_le I hdataLen
                                                          hpayloadOk
                                                      obtain ⟨awCb, k4664, C4664, rd4664,
                                                          hmemCb⟩ :=
                                                        RD.clipperTakeClipperCallExtcodesizeGuard
                                                          (v := v) (hpatch := hpatch)
                                                          rd4530 hmemVat hreadVat hlenMaxNat
                                                          hdataLen (by simpa using hpayloadEnd)
                                                          (by
                                                            simp only [List.length_cons,
                                                              List.length_nil]
                                                            omega)
                                                      by_cases hcallbackCode :
                                                          Reasoning.Theory.extCodeSizeWord σVat
                                                              (UInt256.land
                                                                (clipperTakeWhoWord I)
                                                                solcAddrMask) = ⟨0⟩
                                                      · have hrev :=
                                                            RD.clipperTakeClipperCallNoCode
                                                              (v := v) (hpatch := hpatch)
                                                              rd4664 hcallbackCode (by
                                                                simp only [List.length_cons,
                                                                  List.length_nil]
                                                                omega)
                                                        exact
                                                          clipperTakeOweGtTabCallbackNoCodeRevertEquivFromPostCallAccounts
                                                            (v := v) hcode hwv hdispatch hdec
                                                            hlockedSolm hstoppedSolmLt husrSolm
                                                            hrev (by simpa using hPostAccounts)
                                                            hevmPriceAccounts hevmPriceSigma0
                                                            hevmPriceCreated hevmPriceGenesis
                                                            hevmPriceBlocks hevmPriceEnv htab hlot
                                                            (by rfl) hmaxLe
                                                            (by simpa [sliceE, lotE] using howeMul)
                                                            (by simpa [sliceE, lotE] using hgt)
                                                            hvatCode
                                                            (by simpa [hzVatTrue] using hcallVat)
                                                            hdataLen hpayloadOk hwhoVat hwhoDog
                                                            hcallbackCode hstatus
                                                      · have hoffMaxNat :
                                                            (clipperTakeDataOffsetWord I).toNat ≤
                                                              4294967296 := by
                                                          simpa [solcMaxLen, solcMaxLenV1] using
                                                        ...
                                                        have hdataStartEq :
                                                          ...
                                                          rw [show (⟨32⟩ : UInt256).toNat = 32 by
                                                            decide]
                                                          rw [show (⟨4⟩ : UInt256).toNat = 4 by
                                                            decide]
                                                          ...
                                                          rw [Nat.mod_eq_of_lt (by
                                                            have hbound :
                                                              ...
                                                              native_decide
                                                            omega)]
                                                        obtain ⟨cACb, σCb, zCb, outCb, ACb,
                                                            kCb, CCb, rdCb, hcallCb, houtCb⟩ :=
                                                          RD.clipperTakeClipperCallPostCall
                                                            (v := v) (hpatch := hpatch)
                                                            rd4664 hmemVat hdataLen rfl
                                                            hdataStartEq hlenMaxNat hpayloadOk
                                                            hcallbackCode hdepth hperm (by
                                                              simp only [List.length_cons,
                                                                List.length_nil]
                                                              omega)
                                                        by_cases hzCb : zCb = false
                                                        · have hrev :=
                                                              RD.clipperTakeClipperCallFailure
                                                                (v := v) (hpatch := hpatch)
                                                                (by simpa [hzCb] using rdCb)
                                                                houtCb (by
                                                                  simp only [List.length_cons,
                                                                    List.length_nil]
                                                                  omega)
                                                          exact
                                                            clipperTakeOweGtTabCallbackFailureRevertEquivFromPostCallAccounts
                                                              (v := v) hcode hwv hdispatch hdec
                                                              hlockedSolm hstoppedSolmLt husrSolm
                                                              hrev (by simpa using hPostAccounts)
                                                              hevmPriceAccounts hevmPriceSigma0
                                                              ...
                                                              (by rfl) hmaxLe
                                                              (by
                                                                simpa [sliceE, lotE] using howeMul)
                                                              (by simpa [sliceE, lotE] using hgt)
                                                              hvatCode
                                                              (by simpa [hzVatTrue] using hcallVat)
                                                              (by
                                                                simpa [hzCb, u256_land_comm] using
                                                                  hcallCb)
                                                              hdataLen hpayloadOk hwhoVat hwhoDog
                                                              hcallbackCode hstatus
                                                        · have hzCbTrue : zCb = true :=
                                                            Bool.eq_true_of_not_eq_false hzCb
                                                          obtain ⟨k4701, C4701, rd4701⟩ :=
                                                            RD.clipperTakeClipperCallSuccess
                                                              (v := v) (hpatch := hpatch)
                                                              (by simpa [hzCbTrue] using rdCb)
                                                              (by
                                                                simp only [List.length_cons,
                                                                  List.length_nil]
                                                                omega)
                                                          exact
                                                            clipperTakeOweGtTabCallbackSuccessContinuationEquivFromPostCallAccounts
                                                              (v := v) hpatch hcode hwv
                                                              hdispatch hdec hAccounts
                                                              hlockedSolm hstoppedSolmLt husrSolm
                                                              rd4701 hmemCb
                                                              (by simpa using hPostAccounts)
                                                              hevmPriceAccounts hevmPriceSigma0
                                                              ...
                                                              hvatCode
                                                              (by
                                                                simpa [hzVatTrue] using hcallVat)
                                                              (by
                                                                simpa [hzCbTrue, u256_land_comm]
                                                                  using hcallCb)
                                                              hdataLen hpayloadOk hwhoVat hwhoDog
                                                              hcallbackCode hdepth hperm hstatus
                                            · trace_state
                                              sorry
                                        · have hrev :=
