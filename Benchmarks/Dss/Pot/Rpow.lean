import Benchmarks.Dss.Pot.RpowLoop
...
def rpowLoopTail : List Stmt :=
  [ .ite
      ...
      (checkedMulUintInto "zx" (.var "z") (.var "x") ++
        ...
        [ .assign .localVar { base := "z" } (.binary (.div (.uint ⟨256, by decide⟩) .checked) (.var "zxRound") (.var "base")) ])
      [],
  ...
  have hblock :
      ExecBlock config { contract := contract, locals := locals } evm
        [ .letDecl "xx" (some uint256) (mul256 (.var "x") (.var "x")),
          ...
          .assign .localVar { base := "x" } (.binary (.div (.uint ⟨256, by decide⟩) .checked) (.var "xxRound") (.var "base")) ]
        (.ok { contract := contract, locals := localsX } evm) := by
    refine ExecBlock.consNormal (ExecStmt.letDecl_uint256_word hmulXX) ?_
    refine ExecBlock.consNormal (ExecStmt.requireTrue hmulXXReq) ?_
    refine ExecBlock.consNormal (ExecStmt.letDecl_uint256_word haddXX) ?_
...
theorem execRpowLoopBodyOkOdd {evm : EVM.State} {locals : Store}
  ...
  have hmulZXReq :
      evalExpr? config { contract := contract, locals := localsZX } evm
        (.binary .or
          (.binary .eq (.var "x") (.intLit 0))
          (.binary .eq (.binary (.div (.uint ⟨256, by decide⟩) .checked) (.var "zx") (.var "x")) (.var "z"))) =
        .ok (.bool true) := by
    by_cases hx0 : x' = ⟨0⟩
    · have hxZero :
          evalExpr? config { contract := contract, locals := localsZX } evm
    ...
    · have hxEqZero :
      ...
      have hdiv :
          evalExpr? config { contract := contract, locals := localsZX } evm
            (.binary (.div (.uint ⟨256, by decide⟩) .checked) (.var "zx") (.var "x")) = .ok (.int (Int.ofNat z.toNat)) := by
  ...
  have hdivN :
      evalExpr? config { contract := contract, locals := localsZ } evm
        (.binary (.div (.uint ⟨256, by decide⟩) .checked) (.var "n") (.intLit 2)) = .ok (.int (Int.ofNat n'.toNat)) :=
    evalExpr_div_uint256_ok hstoreZ.eval_n htwoLitZ potUInt256Two_ne_zero rfl
  have hassignN :
  ...
  have hthen :
    ...
    refine ExecBlock.consNormal (ExecStmt.letDecl_uint256_word hmulZX) ?_
    refine ExecBlock.consNormal (ExecStmt.requireTrue hmulZXReq) ?_
    refine ExecBlock.consNormal (ExecStmt.letDecl_uint256_word haddZX) ?_
...
theorem RD.potDripRpowLoopExit
  ...
  have rd2401 := evm_run rd2395 with [
    ...
    raw push2 ⟨2506⟩ (by native_decide) (by evm_ov)]
  have hnDone : UInt256.isZero (⟨0⟩ : UInt256) ≠ ⟨0⟩ := by decide
  have rd2506 := rd2401.jumpiT (by native_decide) hnDone (by jump_dest) (by evm_ov)
  have rd2534pre := evm_run rd2506 with [
    raw jumpdest (by native_decide) (by evm_ov),
    raw pop (by native_decide) (by evm_ov),
    raw push2 ⟨2534⟩ (by native_decide) (by evm_ov)]
  have rd2534 := rd2534pre.jump (by native_decide) (by jump_dest) (by evm_ov)
  have rd2541 := evm_run rd2534 with [
    raw jumpdest (by native_decide) (by evm_ov),
    raw pop (by native_decide) (by evm_ov),
...
theorem RD.potDripRpowLoopBodyEntry
  ...
  have rd2402 := rd2401.jumpiNT (by native_decide) hnNonzero (by evm_ov)
...
theorem RD.potDripRpowLoopRevertXXRound
  ...
  have rd2418 := rd2413.jumpiT (by native_decide) heqCond (by jump_dest) (by evm_ov)
  have hlt : UInt256.lt (xx + half) xx = ⟨1⟩ :=
    u256_add_overflow_lt xx half (by simpa [xx] using hover)
  have rd2429 := evm_run rd2418 with [
    raw jumpdest (by native_decide) (by evm_ov),
    ...
    raw iszero (by native_decide) (by evm_ov),
    raw push2 ⟨2434⟩ (by native_decide) (by evm_ov)]
...
theorem RD.potDripRpowLoopOddTailEntry
  ...
  have heqXXCond : UInt256.eq (UInt256.div (x * x) x) x ≠ ⟨0⟩ := by
    rw [show UInt256.div (x * x) x = x by simpa [xx] using hdivXXWord,
      u256_eq_refl]
    exact one_ne_zero_uint
  have rd2418 := rd2413.jumpiT (by native_decide) heqXXCond (by jump_dest) (by evm_ov)
  have hxxRoundNat : xxRound.toNat = xx.toNat + half.toNat := by
    change (xx + half).toNat = xx.toNat + half.toNat
    rw [uadd_toNat, Nat.mod_eq_of_lt (by simpa [xx] using hfitXXRound)]
  ...
  have hcondXXAdd : UInt256.isZero (UInt256.lt xxRound xx) ≠ ⟨0⟩ := by
    rw [hltXX]
    native_decide
  have rd2434 := rd2429.jumpiT (by native_decide) hcondXXAdd (by jump_dest) (by evm_ov)
  have rd2446 := evm_run rd2434 with [
    raw jumpdest (by native_decide) (by evm_ov),
    raw dup6 (by native_decide) (by evm_ov),
    ...
    raw iszero (by native_decide) (by evm_ov),
    raw push2 ⟨2495⟩ (by native_decide) (by evm_ov)]
  ...
  have rd2450 := rd2446.jumpiNT (by native_decide) hcondOdd (by evm_ov)
...
theorem RD.potDripRpowLoopRevertZX
  ...
  let zx := z * x'
  obtain ⟨_, _, rd2450⟩ :=
    RD.potDripRpowLoopOddTailEntry (R := R) hRlen (hfitXX := hfitXX)
      (hfitXXRound := hfitXXRound) hodd rd2402
  ...
  have hmulGuardFail :
    ...
    rw [hleft, hright]
    native_decide
  have rd2467 := evm_run rd2450 with [
    raw dup6 (by native_decide) (by evm_ov),
...
theorem RD.potDripRpowLoopRevertZXRound
  ...
  have rd2467 := evm_run rd2450 with [
    ...
    raw iszero (by native_decide) (by evm_ov),
    raw push2 ⟨2472⟩ (by native_decide) (by evm_ov)]
  have rd2472 := rd2467.jumpiT (by native_decide) hmulGuard (by jump_dest) (by evm_ov)
  have hlt : UInt256.lt (zx + half) zx = ⟨1⟩ :=
    u256_add_overflow_lt zx half (by simpa [zx, x', xxRound, xx] using hover)
  have rd2483 := evm_run rd2472 with [
    raw jumpdest (by native_decide) (by evm_ov),
    raw dup2 (by native_decide) (by evm_ov),
    raw dup2 (by native_decide) (by evm_ov),
    raw add (by native_decide) (by evm_ov),
    ...
    raw lt (by native_decide) (by evm_ov),
    raw iszero (by native_decide) (by evm_ov),
    raw push2 ⟨2488⟩ (by native_decide) (by evm_ov)]
...
theorem RD.potDripRpowLoopStepEven
  ...
  have hcondAdd : UInt256.isZero (UInt256.lt xxRound xx) ≠ ⟨0⟩ := by
    rw [hlt]
    native_decide
  have rd2434 := rd2429.jumpiT (by native_decide) hcondAdd (by jump_dest) (by evm_ov)
  have rd2446 := evm_run rd2434 with [
    raw jumpdest (by native_decide) (by evm_ov),
    raw dup6 (by native_decide) (by evm_ov),
    raw swap1 (by native_decide) (by evm_ov),
  ...
  have hcondEven : UInt256.isZero (UInt256.land n ⟨1⟩) ≠ ⟨0⟩ := by
    rw [hland]
    native_decide
  have rd2495 := rd2446.jumpiT (by native_decide) hcondEven (by jump_dest) (by evm_ov)
  have rd2502 := evm_run rd2495 with [
    raw jumpdest (by native_decide) (by evm_ov),
    ...
    raw pop (by native_decide) (by evm_ov),
    raw push2 ⟨2395⟩ (by native_decide) (by evm_ov)]
  have rd2395 := rd2502.jump (by native_decide) (by jump_dest) (by evm_ov)
...
theorem RD.potDripRpowLoopStepOdd
  ...
  have hcondZXAdd : UInt256.isZero (UInt256.lt zxRound zx) ≠ ⟨0⟩ := by
    rw [hltZX]
    native_decide
  have rd2488 := rd2483.jumpiT (by native_decide) hcondZXAdd (by jump_dest) (by evm_ov)
  have rd2495 := evm_run rd2488 with [
    raw jumpdest (by native_decide) (by evm_ov),
    raw dup6 (by native_decide) (by evm_ov),
    raw swap1 (by native_decide) (by evm_ov),
    raw div (by native_decide) (by evm_ov),
  ...
  have rd2502 := evm_run rd2495 with [
    ...
    raw push2 ⟨2395⟩ (by native_decide) (by evm_ov)]
  have rd2395 := rd2502.jump (by native_decide) (by jump_dest) (by evm_ov)
  exact ⟨_, _, by simpa [xx, xxRound, x', zx, zxRound, z', n'] using rd2395⟩
...
theorem rpowLoopCoupled
  ...
  induction v with
  | zero =>
      intro x n z locals k C hstore hle rd2395
      ...
      obtain ⟨k', C', rd1926⟩ :=
        RD.potDripRpowLoopExit (R := R) hRlen (by simpa using rd2395)
      exact .inl ⟨x, z, locals, k', C', hstore,
        ExecStmt.whileFalse hwhile, rd1926⟩
  | succ v ih =>
      intro x n z locals k C hstore hle rd2395
      by_cases hnz : n = ⟨0⟩
      · subst n
      ...
      · have hcond : evalExpr? config { contract := contract, locals := locals } evm
        ...
        obtain ⟨_, _, rd2402⟩ :=
          RD.potDripRpowLoopBodyEntry (R := R) hRlen hnz rd2395
        ...
        · have hbody : ExecBlock config { contract := contract, locals := locals } evm
          ...
          have hrev := RD.potDripRpowLoopRevertXX (R := R) hRlen hoverXX rd2402
        ...
        · have hfitXX : x.toNat * x.toNat < UInt256.size := Nat.lt_of_not_ge hoverXX
          ...
          · have hbody : ExecBlock config { contract := contract, locals := locals } evm
            ...
            have hrev := RD.potDripRpowLoopRevertXXRound
              (R := R) hRlen hfitXX hoverXXRound rd2402
            exact .inr ⟨ExecStmt.whileRevert hcond hbody, hrev⟩
          · have hfitXXRound : (x * x).toNat + half.toNat < UInt256.size :=
            ...
            · by_cases hoverZX :
              ...
              · have hbody : ExecBlock config { contract := contract, locals := locals } evm
                ...
                have hrev := RD.potDripRpowLoopRevertZX
                  (R := R) hRlen hfitXX hfitXXRound hodd hoverZX rd2402
                exact .inr ⟨ExecStmt.whileRevert hcond hbody, hrev⟩
              · have hfitZX :
                    z.toNat * (UInt256.div ((x * x) + half) b).toNat < UInt256.size :=
                ...
                · have hbody : ExecBlock config { contract := contract, locals := locals } evm
                    ...
                    execRpowLoopBodyRevertZXRound hstore hb hfitXX hfitXXRound hodd
                      hfitZX hoverZXRound
                  have hrev := RD.potDripRpowLoopRevertZXRound
                    (R := R) hRlen hfitXX hfitXXRound hodd hfitZX hoverZXRound rd2402
                  exact .inr ⟨ExecStmt.whileRevert hcond hbody, hrev⟩
                · have hfitZXRound :
                      (z * UInt256.div ((x * x) + half) b).toNat + half.toNat <
                        UInt256.size :=
                  ...
                  obtain ⟨_, _, rdNext⟩ := RD.potDripRpowLoopStepOdd
                    (R := R) hRlen hfitXX hfitXXRound hodd hfitZX hfitZXRound rd2402
                  have hrec := ih
                  ...
                  | inl hsucc =>
                      ...
                      exact .inl ⟨xFinal, zFinal, localsFinal, k', C', hfinalStore,
                        ExecStmt.whileTrue hcond hbody hwhileRec, rd1926⟩
                  | inr hrev =>
            ...
            · have heven : n.toNat % 2 = 0 := by
              ...
              obtain ⟨_, _, rdNext⟩ := RD.potDripRpowLoopStepEven
                (R := R) hRlen hfitXX hfitXXRound heven rd2402
              have hrec := ih
                (x := UInt256.div ((x * x) + half) b)
                (n := UInt256.div n ⟨2⟩)
                (z := z)
