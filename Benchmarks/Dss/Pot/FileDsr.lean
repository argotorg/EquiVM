...
theorem RD.potFileDsrDecodeToRoutine {code : ByteArray} {g : Sat256} {s0 : State}
  ...
  subst hwf
  have rd390 := h.jumpdest (by decide +native) (by evm_ov)
  have rd391 := rd390.pop (by decide +native) (by evm_ov)
  have rd392 := rd391.dup1 (by decide +native) (by evm_ov)
  have rd393 := rd392.calldataload (by decide +native) (by evm_ov)
  have rd394 := rd393.swap1 (by decide +native) (by evm_ov)
  have rd396 := rd394.push1 ⟨32⟩ (by decide +native) (by evm_ov)
  have rd397 := rd396.add (by decide +native) (by evm_ov)
  have rd398 := rd397.calldataload (by decide +native) (by evm_ov)
  have rd401 := rd398.push2 ⟨990⟩ (by decide +native) (by evm_ov)
  exact ⟨_, _, by
    simpa [calldataWord, show (⟨4⟩ : UInt256).toNat = 4 from by decide,
      show (⟨36⟩ : UInt256).toNat = 36 from by decide]
      using rd401.jump (by decide +native) hroutine (by evm_ov)⟩
...
theorem potFileDsrX_authorized {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
  ...
  have rd1006 := rd1005pre.keccak256 0 (mapSlot (relySourceWord I) ⟨0⟩)
    ...
    (by evm_ov)
  obtain ⟨k1007, C1007, rd1007raw⟩ := rd1006.sload (by decide +native) (by evm_ov)
  ...
  exact ⟨_, _, rd1013.jumpiT (by decide +native) one_ne_zero_uint
...
theorem potFileDsrX_unauthorized {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
  ...
  have rd1013 := rd1010pre.pushConst (⟨1079⟩ : UInt256)
    (width := 2) (op := .PUSH2) (by decide) (by decide +native) (by evm_ov)
  have rd1014 := rd1013.jumpiNT (by decide +native) rfl (by evm_ov)
...
theorem potFileDsrX_liveOK {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
    ...
    ∃ k' C', RD potBytecode I g s0 ⟨1149⟩
      [data, what, ⟨301⟩, sel]
      (relyAuthHashMem I) (UInt256.ofNat 3) ByteArray.empty (cA, σ) k' C' := by
  have rd1080 := h.jumpdest (by decide +native) (by evm_ov)
  have rd1082 := rd1080.push1 ⟨8⟩ (by decide +native) (by evm_ov)
  obtain ⟨k1083, C1083, rd1083raw⟩ := rd1082.sload (by decide +native) (by evm_ov)
  ...
  have rd1088 := rd1085pre.pushConst (⟨1149⟩ : UInt256)
    (width := 2) (op := .PUSH2) (by decide) (by decide +native) (by evm_ov)
  exact ⟨_, _, rd1088.jumpiT (by decide +native) one_ne_zero_uint
    (by jump_dest) (by evm_ov)⟩
...
theorem potFileDsrX_liveRevert {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
  ...
  have rd1088 := rd1085pre.pushConst (⟨1149⟩ : UInt256)
    (width := 2) (op := .PUSH2) (by decide) (by decide +native) (by evm_ov)
  have rd1089 := rd1088.jumpiNT (by decide +native) rfl (by evm_ov)
  exact RD.solcErrorStringRevertTail
    (pc := ⟨1090⟩)
    (len := ⟨12⟩)
...
theorem potFileDsrX_rhoOK {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
    ...
    ∃ k' C', RD potBytecode I g s0 ⟨1225⟩
      [data, what, ⟨301⟩, sel]
      (relyAuthHashMem I) (UInt256.ofNat 3) ByteArray.empty (cA, σ) k' C' := by
  have rd1150 := h.jumpdest (by decide +native) (by evm_ov)
  have rd1152 := rd1150.push1 ⟨7⟩ (by decide +native) (by evm_ov)
  obtain ⟨k1153, C1153, rd1153raw⟩ := rd1152.sload (by decide +native) (by evm_ov)
  ...
  have rd1154 := rd1153.timestamp (by decide +native) (by evm_ov)
  have rd1155 := rd1154.eq (by decide +native) (by evm_ov)
  rw [htime, u256_eq_refl] at rd1155
  have rd1158 := rd1155.pushConst (⟨1225⟩ : UInt256)
    (width := 2) (op := .PUSH2) (by decide) (by decide +native) (by evm_ov)
  exact ⟨_, _, rd1158.jumpiT (by decide +native) one_ne_zero_uint
    (by jump_dest) (by evm_ov)⟩
...
theorem potFileDsrX_rhoRevert {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
  ...
  have rd1158 := rd1155.pushConst (⟨1225⟩ : UInt256)
    (width := 2) (op := .PUSH2) (by decide) (by decide +native) (by evm_ov)
  have rd1159 := rd1158.jumpiNT (by decide +native) rfl (by evm_ov)
  exact RD.solcErrorStringRevertTail
    (pc := ⟨1159⟩)
    (len := ⟨19⟩)
...
theorem potFileDsrX_storeAuthorized {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
    ...
    RDret potBytecode g s0
      ...
      ByteArray.empty := by
  have rd1226 := h.jumpdest (by decide +native) (by evm_ov)
  have rd1227 := rd1226.dup2 (by decide +native) (by evm_ov)
  have rd1231 := rd1227.pushConst (⟨0x3239b9⟩ : UInt256)
    (width := 3) (op := .PUSH3) (by decide) (by decide +native) (by evm_ov)
  have rd1233 := rd1231.push1 ⟨233⟩ (by decide +native) (by evm_ov)
  have rd1234 := rd1233.shl (by decide +native) (by evm_ov)
  have hconst : UInt256.shiftLeft (⟨0x3239b9⟩ : UInt256) ⟨233⟩ =
      ABI.bytesToWord fileDsrBytes := by decide +native
  rw [hmatch, ← hconst] at rd1234
  have rd1235 := rd1234.eq (by decide +native) (by evm_ov)
  rw [uInt256_eq_self] at rd1235
  have rd1236 := rd1235.iszero (by decide +native) (by evm_ov)
  rw [show UInt256.isZero (⟨1⟩ : UInt256) = ⟨0⟩ from by decide] at rd1236
  have rd1239 := rd1236.pushConst (⟨1249⟩ : UInt256)
    (width := 2) (op := .PUSH2) (by decide) (by decide +native) (by evm_ov)
  have rd1240 := rd1239.jumpiNT (by decide +native)
    (by decide : (⟨0⟩ : UInt256) = ⟨0⟩) (by evm_ov)
  have rd1242 := rd1240.push1 ⟨3⟩ (by decide +native) (by evm_ov)
  have rd1243 := rd1242.dup2 (by decide +native) (by evm_ov)
  have rd1244 := rd1243.swap1 (by decide +native) (by evm_ov)
  obtain ⟨_, _, rd1245raw⟩ := rd1244.sstore hperm (by decide +native) (by evm_ov)
  have rd1248 := rd1245raw.push2 ⟨1326⟩ (by decide +native) (by evm_ov)
  have rd1326 := rd1248.jump (by decide +native) (by jump_dest) (by evm_ov)
  ...
  exact RD.stop rd302 (by decide +native) (by evm_ov)
...
theorem potFileDsrX_unrecognized {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
  ...
  have rd1239 := rd1236.pushConst (⟨1249⟩ : UInt256)
    (width := 2) (op := .PUSH2) (by decide) (by decide +native) (by evm_ov)
  have rd1249 := rd1239.jumpiT (by decide +native) one_ne_zero_uint (by jump_dest)
    (by evm_ov)
...
theorem potFileDsrBodyCoreUnrecognized
  ...
  have hneq : calldataWord I.calldata 4 ≠ ABI.bytesToWord fileDsrBytes :=
    fileDsrWhatWord_ne_of_bytes_ne (by omega) hwhat (by decide +native)
