...
theorem potRelyX_authorized {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
  ...
  have rd1388 := rd1387pre.keccak256 0 (mapSlot (relySourceWord I) ⟨0⟩)
    ...
    (by evm_ov)
  obtain ⟨k1389, C1389, rd1389raw⟩ := rd1388.sload (by decide +native) (by evm_ov)
  ...
  exact ⟨_, _, rd1395.jumpiT (by decide +native) one_ne_zero_uint
...
theorem potRelyX_unauthorized {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
  ...
  have rd1395 := rd1392pre.pushConst (⟨1461⟩ : UInt256)
    (width := 2) (op := .PUSH2) (by decide) (by decide +native) (by evm_ov)
  have rd1396 := rd1395.jumpiNT (by decide +native) rfl (by evm_ov)
...
theorem potRelyX_storeAuthorized {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
  ...
  have rd1489pre := evm_run rd1486 with [
    raw push1 ⟨1⟩ (by decide +native) (by evm_ov),
    raw swap1 (by decide +native) (by evm_ov)]
  obtain ⟨_, _, rd1490raw⟩ := rd1489pre.sstore hperm (by decide +native)
    (by simp only [List.length_cons, List.length_nil]; omega)
  have rd301 := rd1490raw.jump (by decide +native) (by jump_dest) (by evm_ov)
