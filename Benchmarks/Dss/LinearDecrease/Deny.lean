...
theorem stairstepReachDenyBody {cA gh bl σ σ₀ A I} {g : Sat256}
  ...
  have htake :
      UInt256.eq
        (armSelNat linearDecreaseBytecode
          (nthArmPc linearDecreaseBytecode stairstepFirstArmPc 3))
        (stairstepSelWord I) ≠ ⟨0⟩ := by
    rw [hword]
    decide +native
...
theorem stairstepDenyX_decoded {cA gh bl σ σ₀ A I} {g : Sat256} {sel : UInt256}
    ...
    ∃ k C, RD linearDecreaseBytecode I g
        (initState cA gh bl σ σ₀ g A I) ⟨795⟩
  ...
  obtain ⟨_, _, hroutine⟩ := RD.solcOneAddressExternalMaskAndJumpMasked
    (code := linearDecreaseBytecode) (decoded := ⟨253⟩) (ret := ⟨138⟩)
    (routine := ⟨795⟩) (R := [sel]) hdecoded
    (by decide +native) (by decide +native) (by decide +native) (by decide +native)
    (by decide +native) (by decide +native) (by decide +native) (by decide +native)
...
theorem stairstepDenyX_authorized {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
    ...
    (h : RD linearDecreaseBytecode I g s0 ⟨795⟩
      [relyUsrMaskedWord I, ⟨138⟩, sel]
      solcFreePtrMem (UInt256.ofNat 3) ByteArray.empty (cA, σ) k C) :
    ∃ k' C', RD linearDecreaseBytecode I g s0 ⟨895⟩
      [relyUsrMaskedWord I, ⟨138⟩, sel]
  ...
  have rd883 : RD linearDecreaseBytecode I g s0 ⟨812⟩
...
theorem stairstepDenyX_storeAuthorized {cA σ I} {g : Sat256} {s0 : State} {k C : ℕ}
    ...
    (h : RD linearDecreaseBytecode I g s0 ⟨895⟩
      [relyUsrMaskedWord I, ⟨138⟩, sel]
