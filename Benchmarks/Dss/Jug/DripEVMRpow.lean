...
theorem RD.jugDripToRpowRoutine
  ...
  have rd1504 := rd1503.add (by decide +native) (by evm_ov)
  ...
  have rd1506 := RD.timestamp rd1505 (by decide +native) (by evm_ov)
  have rd1507 := rd1506.sub (by decide +native) (by evm_ov)
  have rd1520 := rd1507.pushConst jugRay
    (width := 12) (op := .PUSH12) (by decide) (by decide +native) (by evm_ov)
  have rd1523 := rd1520.push2 ⟨2153⟩ (by decide +native) (by evm_ov)
  have rd2153 := rd1523.jump (by decide +native) (by jump_dest) (by evm_ov)
...
theorem RD.jugDripRpowNZeroReturns
  ...
  have rd2162 := evm_run rd2153 with [
    ...
    raw push2 ⟨2313⟩ (by decide +native) (by evm_ov)]
  by_cases hx : x = ⟨0⟩
  · have hxZero : UInt256.isZero x ≠ ⟨0⟩ := by
      rw [hx]
      decide
    have rd2313 := rd2162.jumpiT (by decide +native) hxZero (by jump_dest) (by evm_ov)
    have rd2313' := by
    ...
    have rd2320 := evm_run rd2313' with [
      ...
      raw dup1 (by decide +native) (by evm_ov),
      raw iszero (by decide +native) (by evm_ov),
      raw push2 ⟨2329⟩ (by decide +native) (by evm_ov)]
    have hnZero : UInt256.isZero (⟨0⟩ : UInt256) ≠ ⟨0⟩ := by decide
    have rd2329 := rd2320.jumpiT (by decide +native) hnZero (by jump_dest) (by evm_ov)
  ...
  · have hxNonzero : UInt256.isZero x = ⟨0⟩ := isZero_eq_zero_of_ne hx
    have rd2163 := rd2162.jumpiNT (by decide +native) hxNonzero (by evm_ov)
    have rd2172 := evm_run rd2163 with [
      ...
      raw dup1 (by decide +native) (by evm_ov),
      raw iszero (by decide +native) (by evm_ov),
      raw push2 ⟨2180⟩ (by decide +native) (by evm_ov)]
    have hland : UInt256.land (⟨0⟩ : UInt256) ⟨1⟩ = ⟨0⟩ := by decide
    have hoddZero : UInt256.isZero (UInt256.land (⟨0⟩ : UInt256) ⟨1⟩) ≠ ⟨0⟩ := by
      rw [hland]
      decide
    have rd2180 := rd2172.jumpiT (by decide +native) hoddZero (by jump_dest) (by evm_ov)
...
theorem RD.jugDripRpowNOneReturns
  ...
  · have hxZero : UInt256.isZero x ≠ ⟨0⟩ := by
    ...
    have rd2321 := rd2320.jumpiNT (by decide +native) hnNonzero (by evm_ov)
    have rd2333pre := evm_run rd2321 with [
      raw push1 ⟨0⟩ (by decide +native) (by evm_ov),
      raw swap3 (by decide +native) (by evm_ov),
      raw pop (by decide +native) (by evm_ov),
      raw push2 ⟨2333⟩ (by decide +native) (by evm_ov)]
    have rd2333 := rd2333pre.jump (by decide +native) (by jump_dest) (by evm_ov)
  ...
  · have hxNonzero : UInt256.isZero x = ⟨0⟩ := isZero_eq_zero_of_ne hx
    ...
    have hoddNonzero : UInt256.isZero (UInt256.land (⟨1⟩ : UInt256) ⟨1⟩) = ⟨0⟩ := by
      rw [hland]
      decide
    have rd2173 := rd2172.jumpiNT (by decide +native) hoddNonzero (by evm_ov)
    have rd2184pre := evm_run rd2173 with [
      raw dup6 (by decide +native) (by evm_ov),
      raw swap3 (by decide +native) (by evm_ov),
      raw pop (by decide +native) (by evm_ov),
      raw push2 ⟨2184⟩ (by decide +native) (by evm_ov)]
    have rd2184 := rd2184pre.jump (by decide +native) (by jump_dest) (by evm_ov)
...
theorem RD.jugDripRmulReturns
  ...
  have rd1529 := evm_run rd1524 with [
    ...
    raw push2 ⟨2343⟩ (by decide +native) (by evm_ov)]
  have rd2343 := rd1529.jump (by decide +native) (by jump_dest) (by evm_ov)
  have rd2353 := evm_run rd2343 with [
    ...
    raw iszero (by decide +native) (by evm_ov),
    raw dup1 (by decide +native) (by evm_ov),
    raw push2 ⟨2367⟩ (by decide +native) (by evm_ov)]
  by_cases hprev0 : prev = ⟨0⟩
  · have hcond : UInt256.isZero prev ≠ ⟨0⟩ := by
      rw [hprev0]
      decide
    have rd2367 := rd2353.jumpiT (by decide +native) hcond (by jump_dest) (by evm_ov)
    have rd2371 := evm_run rd2367 with [
      raw jumpdest (by decide +native) (by evm_ov),
      raw push2 ⟨2376⟩ (by decide +native) (by evm_ov)]
    have hcond2 : UInt256.isZero prev ≠ ⟨0⟩ := by
      rw [hprev0]
      decide
    have rd2376 := rd2371.jumpiT (by decide +native) hcond2 (by jump_dest) (by evm_ov)
    have rd2377 := RD.jumpdest rd2376 (by decide +native) (by evm_ov)
    ...
    have rd2396 := evm_run rd2390 with [
      ...
      raw pop (by decide +native) (by evm_ov),
      raw pop (by decide +native) (by evm_ov)]
    have rd1530 := rd2396.jump (by decide +native) (by jump_dest) (by evm_ov)
    exact ⟨_, _, by simpa [hprev0] using rd1530⟩
  · have hcond : UInt256.isZero prev = ⟨0⟩ := isZero_eq_zero_of_ne hprev0
    have rd2354 := rd2353.jumpiNT (by decide +native) hcond (by evm_ov)
    have rd2362 := evm_run rd2354 with [
      ...
      raw dup3 (by decide +native) (by evm_ov),
      raw dup2 (by decide +native) (by evm_ov),
      raw push2 ⟨2364⟩ (by decide +native) (by evm_ov)]
    have rd2364 := rd2362.jumpiT (by decide +native) hprev0 (by jump_dest) (by evm_ov)
    ...
    have rd2376 := rd2368.jumpiT (by decide +native) heqCond (by jump_dest) (by evm_ov)
    have rd2377 := RD.jumpdest rd2376 (by decide +native) (by evm_ov)
    have rd2390 := rd2377.pushConst jugRay
      (width := 12) (op := .PUSH12) (by decide) (by decide +native) (by evm_ov)
    have rd2396 := evm_run rd2390 with [
...
theorem RD.jugDripRmulOverflowReverts
  ...
  have rd2362 := evm_run rd2354 with [
    ...
    raw dup2 (by decide +native) (by evm_ov),
    raw push2 ⟨2364⟩ (by decide +native) (by evm_ov)]
  have rd2364 := rd2362.jumpiT (by decide +native) hprevNe (by jump_dest) (by evm_ov)
  have rd2368 := evm_run rd2364 with [
    raw jumpdest (by decide +native) (by evm_ov),
    raw div (by decide +native) (by evm_ov),
    raw eq (by decide +native) (by evm_ov),
  ...
  have rdFallthrough := rd2368.jumpiNT (by decide +native) heqCond (by evm_ov)
...
theorem RD.jugDiffSameReturnsZero
  ...
  have rd2412 := rd2411.jumpiNT (by decide +native)
    (by simpa using hslt)
    (by evm_ov)
  ...
  have hcond : UInt256.isZero (UInt256.slt v (⟨0⟩ : UInt256)) ≠ ⟨0⟩ := by
    rw [hslt]
    decide
  have rd2147 := rd2422.jumpiT (by decide +native) hcond (by jump_dest) (by evm_ov)
  have rd2152 := evm_run rd2147 with [
    ...
    raw pop (by decide +native) (by evm_ov),
    raw pop (by decide +native) (by evm_ov)]
  have rd1570 := rd2152.jump (by decide +native) (by jump_dest) (by evm_ov)
...
theorem RD.jugDiffSameRevertXBound
  ...
  have hcond : UInt256.slt v (⟨0⟩ : UInt256) ≠ ⟨0⟩ := by
    rw [hslt]
    decide
  have rd2418 := rd2411.jumpiT (by decide +native) hcond (by jump_dest) (by evm_ov)
  ...
  have hcond2 : UInt256.isZero (UInt256.slt v (⟨0⟩ : UInt256)) = ⟨0⟩ := by
    rw [hslt]
    decide
  have rd2423 := rd2422.jumpiNT (by decide +native) hcond2 (by evm_ov)
...
theorem RD.jugDiffRevertYBound
  ...
  have hcond : UInt256.isZero (UInt256.slt prev (⟨0⟩ : UInt256)) = ⟨0⟩ := by
    rw [hprevSlt]
    decide
  have rd2423 := rd2422.jumpiNT (by decide +native) hcond (by evm_ov)
  exact RD.solcPush1Dup1Revert0 rd2423
    (by decide +native) (by decide +native) (by decide +native)
    (by simp only [List.length_cons, List.length_nil]; omega)
