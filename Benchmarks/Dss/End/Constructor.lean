...
theorem endRuntimeBytecode_size :
...
theorem endCtorWardsHashMem_read64 (I : ExecutionEnv) :
    (endCtorWardsHashMem I).readWithPadding 64 32 = UInt256.toByteArray ⟨128⟩ := by
...
theorem endCtorReturnMem_read (I : ExecutionEnv) :
  ...
  rw [write0_read_back_from_gen endCreationBytecode
    (endCtorWardsHashMem I) 94 10265
...
def endCtorAfterLiveState (evm : EVM.State) : EVM.State :=
  Solm.EVM.storageStore (endCtorAfterWardsState evm)
    (endCtorAfterWardsState evm).executionEnv.codeOwner ⟨8⟩ ⟨1⟩
...
theorem assign_endCtorWardsCaller (evm : EVM.State) {locals : Store}
  ...
  have hstore :
    ...
    simpa [endCtorAfterWardsState, wordLoc, uint256Loc, uint256Int] using
...
theorem assign_endCtorLive (evm : EVM.State) {locals : Store}
    ...
    assignStorageRef? config { contract := contract, locals := locals } evm
      .storage liveRef (.int 1) =
        .ok ({ contract := contract, locals := locals },
          Solm.EVM.storageStore evm evm.executionEnv.codeOwner ⟨8⟩ ⟨1⟩) := by
  have her :
  ...
  have hstore :
      storageLocStore evm (wordLoc ⟨8⟩) (.int 1) =
        some (Solm.EVM.storageStore evm evm.executionEnv.codeOwner ⟨8⟩ ⟨1⟩) := by
    simpa [wordLoc, uint256Loc, uint256Int] using storageLocStore_uint256 evm ⟨8⟩ ⟨1⟩
  exact assignStorageRef_storage_scalar
    (ty := uint256St)
    (loc := wordLoc ⟨8⟩)
...
theorem endCtorBodySuccess
    ...
    let evm1 := endCtorAfterLiveState evm0
  ...
  have hassignWards :
      assignStorageRef? config { contract := contract, locals := ∅ } evm0
        .storage (wardsRef sender) (.int 1) =
          .ok ({ contract := contract, locals := ∅ }, endCtorAfterWardsState evm0) := by
    exact assign_endCtorWardsCaller evm0 (locals := ∅) (by simp)
  have hassignLive :
      assignStorageRef? config { contract := contract, locals := ∅ } (endCtorAfterWardsState evm0)
        .storage liveRef (.int 1) =
          .ok ({ contract := contract, locals := ∅ }, evm1) := by
    simpa [evm1, endCtorAfterLiveState, storageStore_executionEnv] using
      assign_endCtorLive (endCtorAfterWardsState evm0) (locals := ∅) (by simp)
...
theorem endCtorInitcodeSuccess {cA gh bl σ σ₀ A I} {g : Sat256}
  ...
  have rd37pre := evm_run rd34 with [
    raw push1 ⟨1⟩ (by native_decide) (by evm_ov),
    raw swap1 (by native_decide) (by evm_ov),
    raw dup2 (by native_decide) (by evm_ov),
    raw swap1 (by native_decide) (by evm_ov)]
  obtain ⟨_, _, rd38raw⟩ := rd37pre.sstore hperm (by native_decide)
    (by simp only [List.length_cons, List.length_nil]; omega)
  have rd38 := by
    simpa using rd38raw
  have rd40pre := evm_run rd38 with [
    raw push1 ⟨8⟩ (by native_decide) (by evm_ov)]
  obtain ⟨_, _, rd41raw⟩ := rd40pre.sstore hperm (by native_decide)
    (by simp only [List.length_cons, List.length_nil]; omega)
  have rd41 := by
    simpa using rd41raw
  have rd42 := rd41.mload 0 ⟨128⟩ (UInt256.ofNat 3) (by native_decide) mem_cost
    (mloadFreePtrValue (by rw [endCtorWardsHashMem_size I]; decide) (by decide)
      (endCtorWardsHashMem_read64 I))
    (by native_decide) (by evm_ov)
  have rd75 := rd42.pushConst
    (⟨0xdd0e34038ac38b2a1ce960229778ac48a8719bc900b6c4f8d0475c6e8b385a60⟩ : UInt256)
    (width := 32) (op := .PUSH32) (by decide) (by native_decide) (by evm_ov)
  have rd77pre := evm_run rd75 with [
  ...
  have rd78 := RD.log2
    ...
    (UInt256.ofNat
      (MachineState.M (UInt256.ofNat 3).toNat (⟨128⟩ : UInt256).toNat
        (⟨0⟩ : UInt256).toNat))
    rd77pre (by native_decide) hperm mem_cost (by native_decide)
    (by simp only [List.length_nil]; omega)
  have hcopy :
      endCreationBytecode.write 94 (endCtorWardsHashMem I) 0 10265 =
        endCtorReturnMem I := by
    rfl
  have rd90pre := evm_run rd78 with [
    raw push2 ⟨10265⟩ (by native_decide) (by evm_ov),
    raw dup1 (by native_decide) (by evm_ov),
    raw push2 ⟨94⟩ (by native_decide) (by evm_ov),
    raw push1 ⟨0⟩ (by native_decide) (by evm_ov),
    raw codecopy
      (Cₘ (UInt256.ofNat (MachineState.M (UInt256.ofNat 3).toNat 0 10265)) -
        Cₘ (UInt256.ofNat 3))
  ...
  · have hrd := endCtorInitcodeSuccess
    ...
    · have hsuccess := Xi_success_of_X (g := g) (by
      ...
      · have hslot : wardsSlot (.address I.source) = endCtorCallerWardsSlot I :=
        ...
        have hmap1 :
            accountMapEquiv
              (sstoreAccountMap I.codeOwner σ_evm (endCtorCallerWardsSlot I) ⟨1⟩)
              (sstoreAccountMap I.codeOwner σ_solm (endCtorCallerWardsSlot I) ⟨1⟩) :=
          accountMapEquiv_sstoreAccountMap I.codeOwner (endCtorCallerWardsSlot I) ⟨1⟩
            hAccounts
        simpa [evm0s, endCtorAfterLiveState, endCtorAfterWardsState,
          storageStore_accountMap, storageStore_executionEnv, initState, hslot] using
          accountMapEquiv_sstoreAccountMap I.codeOwner ⟨8⟩ ⟨1⟩ hmap1
