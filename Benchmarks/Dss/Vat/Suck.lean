...
theorem vatSuckSourceSuccess (evm : EVM.State) (I : ExecutionEnv)
  ...
  have h01 := Reasoning.Refinement.execBlock_append hprefix hsinAdd
  have h02 := Reasoning.Refinement.execBlock_append h01 hsinAssign
  have h03 := Reasoning.Refinement.execBlock_append h02 hdaiAdd
  have h04 := Reasoning.Refinement.execBlock_append h03 hdaiAssign
  have h05 := Reasoning.Refinement.execBlock_append h04 hviceAdd
  have h06 := Reasoning.Refinement.execBlock_append h05 hviceAssign
  have h07 := Reasoning.Refinement.execBlock_append h06 hdebtAdd
  have hblock := Reasoning.Refinement.execBlock_append h07 hdebtAssign
...
theorem vatSuckSourceRevertDaiOverflow (evm : EVM.State) (I : ExecutionEnv)
  ...
  have h01 := Reasoning.Refinement.execBlock_append hprefix hsinAdd
  have h02 := Reasoning.Refinement.execBlock_append h01 hsinAssign
  have h03 := Reasoning.Refinement.execBlock_append h02 hdaiRevert
...
theorem vatSuckSourceRevertViceOverflow (evm : EVM.State) (I : ExecutionEnv)
  ...
  have h03 := Reasoning.Refinement.execBlock_append h02 hdaiAdd
  have h04 := Reasoning.Refinement.execBlock_append h03 hdaiAssign
  have h05 := Reasoning.Refinement.execBlock_append h04 hviceRevert
  have hblock := Reasoning.Refinement.execBlock_append_term
    (s2 :=
      [ .assign .storage viceRef (.var "viceNew") ] ++
      checkedAddUintInto "debtNew" (.storage debtRef) (.var "rad") ++
...
theorem vatSuckSourceRevertDebtOverflow (evm : EVM.State) (I : ExecutionEnv)
  ...
  have h05 := Reasoning.Refinement.execBlock_append h04 hviceAdd
  have h06 := Reasoning.Refinement.execBlock_append h05 hviceAssign
  have h07 := Reasoning.Refinement.execBlock_append h06 hdebtRevert
  have hblock := Reasoning.Refinement.execBlock_append_term
