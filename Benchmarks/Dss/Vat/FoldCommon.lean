...
theorem vatFoldSourceRevertAfterDaiBlock (evm evmRate : EVM.State) (I : ExecutionEnv)
  ...
  have h02 := Reasoning.Refinement.execBlock_append h01 hradOk
...
theorem vatFoldSourceRevertAfterDebtBlock
  ...
  have h01 := Reasoning.Refinement.execBlock_append hprefix hrateOk
  have h02 := Reasoning.Refinement.execBlock_append h01 hradOk
  have h03 := Reasoning.Refinement.execBlock_append h02 hdaiOk
  have h04 := Reasoning.Refinement.execBlock_append h03 hdaiAssign
  have h05 := Reasoning.Refinement.execBlock_append h04 hdebtRevert
  have hblock := Reasoning.Refinement.execBlock_append_term
