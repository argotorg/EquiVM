...
theorem auctionUnpauseX_toInternalUnpause {cA gh bl σ σ₀ A I} {g : Sat256}
  ...
  obtain ⟨_, _, rd1080₁⟩ := rd1080₀.sload (by decide) (by evm_ov)
...
theorem auctionUnpauseRoutine_success {cA gh bl σInit σ σ₀ A I} {g : Sat256}
  ...
  obtain ⟨_, _, rd2857₁⟩ := rd2857₀.sload (by decide) (by evm_ov)
  ...
  obtain ⟨_, _, rd2931₁⟩ := rd2931₀.sload (by decide) (by evm_ov)
  ...
  have rd2936 := rd2936₀
  rw [hclear] at rd2936
  obtain ⟨_, _, rd2937₀⟩ := rd2936.sstore hperm (by decide) (by evm_ov)
...
theorem auctionX_unpause_success_noCreate {cA gh bl σ σ₀ A I} {g : Sat256}
  ...
  obtain ⟨_, _, rd1130₁⟩ := rd1130₀.sload (by decide) (by evm_ov)
  have hstartPost' :
  ...
  obtain ⟨_, _, rd1140₁⟩ := rd1137.sload (by decide) (by evm_ov)
  have hsettledPost' :
