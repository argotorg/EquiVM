...
theorem errorStringRoundedAllocWord_toNat {off len : Nat}
    (hsumLt : off + len + 63 < UInt256.size) :
    ...
    roundedLen.toNat = errorStringRoundedAllocNat off len := by
  intro offW lenW payloadLen roundedLen
  have hoffLt : off < UInt256.size := by omega
  have hlenLt : len < UInt256.size := by omega
...
theorem errorStringNewFreeWord_toNat {off len : Nat}
  ...
  have hsum : off + len + 63 < UInt256.size := by
    ...
    omega
  have hround : roundedLen.toNat = errorStringRoundedAllocNat off len :=
    errorStringRoundedAllocWord_toNat hsum
  have hroundLe : errorStringRoundedAllocNat off len ≤ off + len + 63 := Nat.and_le_right
  have hnewLt : 128 + errorStringRoundedAllocNat off len < UInt256.size := by
    norm_num [ABI.solcMaxU64, UInt256.size] at hoffMax hlenMax ⊢
    omega
  change ((⟨128⟩ : UInt256) + roundedLen).toNat = 128 + errorStringRoundedAllocNat off len
  rw [uadd_toNat, show (⟨128⟩ : UInt256).toNat = 128 by rfl, hround, Nat.mod_eq_of_lt hnewLt]
...
theorem auctionCreateAuction_mintCallFailureErrorStringToDecoder {cA gh bl σInit σ₀ A I}
  ...
  exact auctionMintFailureSwitchToDecoder rd3123 (by evm_ov)
...
theorem auctionCreateAuction_errorStringDecoderLoadFreePtr {cA gh bl σInit σ₀ A I}
  ...
  have rd5941 := RD.push1 rd ⟨64⟩ (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5942 := RD.mload (Cₘ awLoad - Cₘ aw) fmp awLoad rd5941 (by native_decide)
...
theorem auctionCreateAuction_errorStringDecoderPrepareCopy {cA gh bl σInit σ₀ A I}
    ...
    ∃ k' C', RD auctionBytecode I g (initState cA gh bl σInit σ₀ g A I) ⟨5951⟩
      ...
      mem aw o acc k' C' := by
  have rd5944 := RD.push1 rd ⟨3⟩ (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5945 := RD.not rd5944 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5946 := RD.returndatasize rd5945 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5947 := RD.dup2 rd5946 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5948 := RD.add rd5947 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5950 := RD.push1 rd5948 ⟨4⟩ (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5951 := RD.dup4 rd5950 (by native_decide)
    (by simp only [List.length_cons]; omega)
...
theorem auctionCreateAuction_errorStringDecoderLoadOffset {cA gh bl σInit σ₀ A I}
  ...
  have rd5953 := RD.dup2 rd (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5954 := RD.mload (Cₘ awLoad - Cₘ aw) off awLoad rd5953 (by native_decide)
    (fun _ haws hstks => auctionMloadCost_of_stack haws hstks (by rfl))
    hmloadFmp (by rfl)
    (by simp only [List.length_cons]; omega)
...
theorem auctionCreateAuction_errorStringDecoderOffsetBoundsOk {cA gh bl σInit σ₀ A I}
  ...
  have hgtMax : UInt256.gt off max64 = ⟨0⟩ := by
    ...
    simp [max64]
    exact hoffMax
  have rd5955 := RD.returndatasize rd (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5964 := RD.pushConst rd5955 max64 (width := 8) (op := .PUSH8)
    (by decide) (by native_decide) (by simp only [List.length_cons]; omega)
  have rd5965 := RD.dup2 rd5964 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5967 := RD.push1 rd5965 ⟨36⟩ (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5968 := RD.dup5 rd5967 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5969 := RD.add rd5968 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5970₀ := RD.gt rd5969 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5970 := rd5970₀
  rw [hgtLen] at rd5970
  have rd5971 := RD.dup2 rd5970 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5972 := RD.dup5 rd5971 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5973₀ := RD.gt rd5972 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5973 := rd5973₀
  rw [hgtMax] at rd5973
  have rd5974₀ := RD.lor rd5973 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5974 := rd5974₀
  rw [show UInt256.lor (⟨0⟩ : UInt256) ⟨0⟩ = ⟨0⟩ by decide] at rd5974
  have rd5975₀ := RD.iszero rd5974 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5975 := rd5975₀
  rw [show UInt256.isZero (⟨0⟩ : UInt256) = ⟨1⟩ from by decide] at rd5975
  have rd5986 := RD.push2 rd5975 ⟨5986⟩ (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5986' := RD.jumpiT rd5986 (by native_decide) (by decide) (by jump_dest)
    (by simp only [List.length_cons]; omega)
  have rd5987 := RD.jumpdest rd5986' (by native_decide)
    (by simp only [List.length_cons]; omega)
...
theorem auctionCreateAuction_errorStringDecoderLoadLengthOk {cA gh bl σInit σ₀ A I}
  ...
  have hgtLenMax : UInt256.gt len max64 = ⟨0⟩ := by
    ...
    simp [max64]
    exact hlenMax
  have rd5988 := RD.dup3 rd (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5989 := RD.dup6 rd5988 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5990 := RD.add rd5989 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5991 := RD.swap2 rd5990 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5992 := RD.pop rd5991 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5993 := RD.dup2 rd5992 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5994 := RD.mload (Cₘ awLoad - Cₘ aw) len awLoad rd5993 (by native_decide)
    (fun _ haws hstks => auctionMloadCost_of_stack haws hstks (by rfl))
    (by simpa [lenPtr] using hmloadLen) (by rfl)
    (by simp only [List.length_cons]; omega)
  have rd5995 := RD.dup2 rd5994 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5996 := RD.dup2 rd5995 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5997₀ := RD.gt rd5996 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5997 := rd5997₀
  rw [hgtLenMax] at rd5997
  have rd5998₀ := RD.iszero rd5997 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5998 := rd5998₀
  rw [show UInt256.isZero (⟨0⟩ : UInt256) = ⟨1⟩ from by decide] at rd5998
  have rd6001 := RD.push2 rd5998 ⟨6010⟩ (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd6010 := RD.jumpiT rd6001 (by native_decide) (by decide) (by jump_dest)
    (by simp only [List.length_cons]; omega)
  have rd6011 := RD.jumpdest rd6010 (by native_decide)
    (by simp only [List.length_cons]; omega)
...
theorem auctionCreateAuction_errorStringDecoderPayloadBoundsOk {cA gh bl σInit σ₀ A I}
  ...
  have rd6012 := RD.dup5 rd (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd6013 := RD.returndatasize rd6012 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd6014 := RD.dup8 rd6013 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd6015 := RD.add rd6014 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd6016 := RD.add rd6015 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd6018 := RD.push1 rd6016 ⟨32⟩ (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd6019 := RD.dup3 rd6018 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd6020 := RD.dup6 rd6019 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd6021 := RD.add rd6020 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd6022 := RD.add rd6021 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd6023₀ := RD.gt rd6022 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd6023 := rd6023₀
  rw [hgtPayload] at rd6023
  have rd6024₀ := RD.iszero rd6023 (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd6024 := rd6024₀
  rw [show UInt256.isZero (⟨0⟩ : UInt256) = ⟨1⟩ from by decide] at rd6024
  have rd6027 := RD.push2 rd6024 ⟨6036⟩ (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd6036 := RD.jumpiT rd6027 (by native_decide) (by decide) (by jump_dest)
    (by simp only [List.length_cons]; omega)
  have rd6037 := RD.jumpdest rd6036 (by native_decide)
    (by simp only [List.length_cons]; omega)
...
theorem auctionCreateAuction_errorStringDecoderCopyToReturn {cA gh bl σInit σ₀ A I}
  ...
  have rd5898 := RD.push2 rd5895 ⟨5918⟩ (by native_decide)
    (by simp only [List.length_cons]; omega)
  have rd5918 := RD.jumpiT rd5898 (by native_decide) (by decide) (by jump_dest)
    (by simp only [List.length_cons]; omega)
  have rd5922₀ := evm_run rd5918 with [
    jumpdest, push1 ⟨64⟩,
    raw mstore (Cₘ awFree - Cₘ aw) memFree awFree (by native_decide)
      (fun s haw hstk => by
