import Benchmarks.Auction.SettleAuctionTransferBranchPayoutEmptyCodeDepositFailure
...
theorem transferBranchPayoutFailureEmptyWethCodeDepositMadeFailureCase
  ...
  have hrdAfterDepFail :
    ...
    simpa [amountWord, ownerWord, memDeposit, wethWord, hminDep,
      byteArray_write_len_zero, hawDep] using hrdAfterDepRaw
  exact transferBranchPayoutFailureEmptyWethCodeDepositFailureCase
    ...
    hrdAfterDepFail houtDepSize hwethCodeE
