...
/-- `setRewardsClaimed(address,address[],uint256[])` body, reached at pc 1723. -/
theorem cometRewardsSetRewardsClaimedBodyCore {cA gh bl σ_evm σ_solm σ₀ A I}
    {g : UInt256}
    ...
    (hreach : ∃ k C, RD cometRewardsBytecode I (Sat256.ofUInt256 g)
      (initState cA gh bl σ_evm σ₀ (Sat256.ofUInt256 g) A I) setRewardsClaimedPc
