...
/-- Refinement of `OnERC1155BatchReceived` (selector index 18). -/
theorem tlcOnERC1155BatchReceivedBodyCore {cA gh bl σ_evm σ_solm σ₀ A I} {g : UInt256}
    (hcode : I.code = timelockControllerBenchBytecode) (hsize : I.calldata.size < UInt256.size)
    (_hperm : I.perm = true) (hsel : selIs I (tlcSelBytes 18))
