...
/-!
# OpenZeppelin ERC6909 (Solidity spec language)

Transcribed from `Examples/OpenZeppelinBench/vendor/openzeppelin-contracts/contracts/`:
`interfaces/IERC6909.sol` (the `IERC6909` interface only) and `token/ERC6909/ERC6909.sol`.
`from`/`to` are Lean keywords, hence «from»/«to».
-/
...
def ierc6909 : SourceUnit := sol% interface IERC6909 is IERC165 {
...
def erc6909 : SourceUnit := sol% contract ERC6909 is Context, ERC165, IERC6909 {
